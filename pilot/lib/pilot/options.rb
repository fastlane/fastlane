  ...
  class Options
    def self.available_options
      ...
      [
          ...
          FastlaneCore::ConfigItem.new(key: :review_contact_info,
                                       short_option: "-y",
                                       optional: true,
                                       env_name: "PILOT_BETA_APP_CONTACT_REVIEW_LAST_NAME",
                                       is_string: false,
                                       description: "Provide the beta app contact information review_last_name when uploading a new build to beta review"),

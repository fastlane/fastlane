...
gem "danger", "~> 9.0"
# erb >= 5.0 (pulled in transitively by irb -> rdoc) requires Ruby >= 3.2, while fastlane supports Ruby >= 3.1.
gem "erb", "< 5.0"
# A fake filesystem.
...
gem "rb-readline"
# rdoc >= 8.0 (pulled in transitively by irb) requires Ruby >= 3.2, while fastlane supports Ruby >= 3.1.
gem "rdoc", "< 8.0"

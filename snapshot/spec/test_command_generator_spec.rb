describe Snapshot do
  describe Snapshot::TestCommandGenerator do
    ...
    describe 'copy_simulator_logs' do
      ...
      it 'copies all device log archives to the output directory on macOS 10.12 (Sierra)',
        ...
        Snapshot::SimulatorLauncher.new(launcher_configuration: launcher_config)
    ...
    describe 'Valid iOS Configuration' do
      ...
      context 'default options' do
        it 'uses the default parameters', requires_xcode: true do
          ...
          command =
            Snapshot::TestCommandGenerator.generate(
              devices: ['iPhone 6'],
              language: 'en',
              locale: nil,
      ...
      context 'fixed derivedDataPath' do
        ...
        it 'uses the fixed derivedDataPath if given', requires_xcode: true do
          ...
          command =
            Snapshot::TestCommandGenerator.generate(
              devices: ['iPhone 6'], language: 'en', locale: nil
            )
      ...
      context 'test-without-building' do
        ...
        it 'uses the "test-without-building" command and not the default "build test"',
           requires_xcode: true do
          command =
            Snapshot::TestCommandGenerator.generate(
              devices: ['iPhone 6'], language: 'en', locale: nil
    ...
    describe 'Unique logs' do
      ...
      let(:simulator_launcher) do
        ...
        return simulator_launcher =
          Snapshot::SimulatorLauncher.new(
      ...
      it 'uses correct name and language', requires_xcode: true do
        log_path =
          simulator_launcher.xcodebuild_log_path(language: 'pt', locale: nil)
      ...
      it 'uses includes locale if specified', requires_xcode: true do
        log_path =
          simulator_launcher.xcodebuild_log_path(

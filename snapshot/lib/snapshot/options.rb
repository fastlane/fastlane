    ...
    def self.available_options
      ...
      @options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :erase_simulator,
                                     ...
                                     default_value: false,
                                     is_string: false),
        FastlaneCore::ConfigItem.new(key: :disable_spellcheck_on_simulator,
                                     env_name: 'SNAPSHOT_DISABLE_SPELLCHECK',
                                     description: "Enabling this option will disabling spell checking and auto correcting on the simulator",
                                     default_value: false,
                                     is_string: false),

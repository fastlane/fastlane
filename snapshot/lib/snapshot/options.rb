    ...
    def self.available_options
      ...
      @options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :cloned_source_packages_path,
                                     ...
                                     type: String,
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :skip_resolve_package_dependencies,
                                     env_name: "SNAPSHOT_SKIP_RESOLVE_PACKAGE_DEPENDENCIES",
                                     description: "Skips manual resolution of Swift Package Manager dependencies",
                                     type: Boolean,
                                     optional: true,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :disable_automatic_package_resolution,
                                     env_name: "SNAPSHOT_DISABLE_AUTOMATIC_PACKAGE_RESOLUTION",

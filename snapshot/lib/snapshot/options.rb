    ...
    def self.available_options
      ...
      @options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :erase_simulator,
                                     ...
                                     default_value: false,
                                     is_string: false),
        FastlaneCore::ConfigItem.new(key: :enable_check_spelling,
                                     env_name: 'SNAPSHOT_ENABLE_CHECK_SPELLING',
                                     description: "Enabling this option will turn on keyboard check spelling and auto correcting",
                                     default_value: true,
                                     is_string: false),

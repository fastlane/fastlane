  ...
  class Options
    def self.available_options
      ...
      @options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :video_output_directory,
                                     short_option: "-r",
                                     env_name: "SNAPSHOT_VIDEO_OUTPUT_DIRECTORY",
                                     description: "The directory where to store the videos",
                                     default_value: video_output_directory),

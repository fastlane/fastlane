...
If it is a server issue, it’s best to [file a radar](https://bugreport.apple.com/) or calls the [App Store Connect hotline](https://developer.apple.com/contact/phone/).
...
The key is to do the same action you want to test on both the website and in _spaceship_, so you can see how the requests are different.

...
describe Match::CommandsGenerator do
  ...
  describe ":decrypt option handling" do
    ...
    it "can use the git_url short flag from tool options" do
      ...
      expect_githelper_clone_with('git@github.com:you/your_repo.git', false, { branch: 'master', clone_branch_directly: false, disable_encryption: false })
    ...
    it "can use the shallow_clone flag from tool options" do
      ...
      expect_githelper_clone_with('git@github.com:you/your_repo.git', true, { branch: 'master', clone_branch_directly: false, disable_encryption: false })

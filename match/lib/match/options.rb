    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :s3_force_path_style,
                                     ...
                                     type: Boolean,
                                     description: "When true, the S3 bucket name remains in the request URI (and not moved to the sub-domain)",
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :s3_ssl_verify_peer,
                                     env_name: "MATCH_S3_SSL_VERIFY_PEER",
                                     type: Boolean,
                                     description: "When false, SSL peer certificates are not verified when establishing a connection",
                                     optional: true),

    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :readonly,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :skip_profile,
                                     env_name: "SKIP_PROFILE",
                                     description: "Skip creating or downloading a provisioning profile; useful when using Xcode 8 Automatic Provisioning",
                                     is_string: false,
                                     default_value: false),

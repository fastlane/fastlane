    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :zip_file,
                                     short_option: "-z",
                                     env_name: "MATCH_ZIP_FILE",
                                     description: "The Zip file path for the exported certs/profiles",
                                     default_value: "export.zip",
                                     optional: true),
        ...
        FastlaneCore::ConfigItem.new(key: :force,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :export,
                                     env_name: "MATCH_EXPORT",
                                     description: "Export Certificats and Profiles",
                                     is_string: false,
                                     default_value: false),

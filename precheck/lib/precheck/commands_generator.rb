...
module Precheck
  class CommandsGenerator
    ...
    def run
      ...
      program :help,
              'Author',
              'Joshua Liebowitz <taquitos@gmail.com>, @taquitos'
      ...
      command :init do |c|
        ...
        c.action do |args, options|
          ...
          if is_swift_fastfile
            ...
            if File.exist?(path)
              UI.user_error!('Precheckfile.swift already exists')
            end
          end
          ...
          if is_swift_fastfile
            template =
              File.read(
                "#{Precheck::ROOT}/lib/assets/PrecheckfileTemplate.swift"
              )
          else
            template =
              File.read("#{Precheck::ROOT}/lib/assets/PrecheckfileTemplate")
          end

...
module Precheck
  ...
  class Rule < FastlaneCore::ConfigItem
    ...
    def check_item(item)
      ...
      unless item_field_supported?(item_name: item.item_name)
        return skip_item_not_meant_for_this_rule(item)
      end

...
module Precheck
  describe Precheck do
    describe Precheck::CopyrightDateRule do
      ...
      let(:old_copyright_item) do
        TextItemToCheck.new('Copyright taquitos, 2016', :copyright, 'copyright')
      end
      let(:empty_copyright_item) do
        TextItemToCheck.new(nil, :copyright, 'copyright')
      end
      ...
      it "skips for fields that aren't copyright" do
        not_copyright_item =
          TextItemToCheck.new('not copyright', :description, 'description')

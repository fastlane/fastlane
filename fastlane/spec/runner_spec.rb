  ...
  describe Fastlane::Runner do
    describe '#available_lanes' do
      ...
      it 'lists all available lanes' do
        expect(@ff.runner.available_lanes).to eq(
                    [
                      'test',
                      'anotherroot',
                      'mac beta',
                      ...
                      'android beta',
                      'android witherror',
                      'android unsupported_action'
                    ]
                  )
      end

      it 'allows filtering of results' do
        expect(@ff.runner.available_lanes('android')).to eq(
                    [
                      'android beta',
                      'android witherror',
                      'android unsupported_action'
      ...
      it "doesn't show private lanes" do
        expect(@ff.runner.available_lanes).to_not(
          include('android such_private')
        )
      end
    end
  end

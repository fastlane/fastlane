      ...
      describe 'Android' do
        describe 'Valid parameters' do
          it 'works with valid parameters' do
            ...
            expect(Fastlane::Helper::CrashlyticsHelper).to receive(
                        :generate_android_manifest_tempfile
                      )
                        .once
            ...
            ].each { |to_be| expect(command.join(' ')).to include(to_be) }
          end
        end
        ...
        describe 'Valid Parameters' do
          ...
          it 'works automatically stores the notes in a file if given' do
            ...
            [
              ...
              '-notifications YES',
              '-debug NO'
            ].each { |to_be| expect(command).to include(to_be) }
          end
          ...
          it 'works when using environment variables in place of parameters' do
            ...
            ENV['CRASHLYTICS_FRAMEWORK_PATH'] =
              './fastlane/spec/fixtures/actions/crashlytics/submit'
        ...
        describe 'Invalid Parameters' do
            ...
            expect do
              Fastlane::FastFile.new.parse(
                ...
                .execute(:test)
                        ...
                        %r{Couldn't find crashlytics at path .*fastlane/wadus}
                      )
          end
          ...
          it 'raises an error if the given crashlytics path is not a submit binary' do
            expect(Fastlane::Helper::CrashlyticsHelper).to receive(
                        ...
                        .and_return(
                        './fastfile/spec/fixtures/fastfiles/Fastfile1'
                      )
            expect do
              Fastlane::FastFile.new.parse(
                "lane :test do
                ...
                .execute(:test)
                        ...
                        %r{Invalid crashlytics path was detected with '.*Fastfile1'. Path must point to the `submit` binary \(example: './Pods/Crashlytics/submit'\)}
                      )
          end
            ...
            expect do
              Fastlane::FastFile.new.parse(
                ...
                .execute(:test)
                        ...
                        "Couldn't find ipa file at path './fastlane/wadus'"
                      )
          end
        end
      end

  ...
  describe Fastlane::FastFile do
    describe 'Setup Jenkins Integration' do
      before :each do
        ...
        Fastlane::Actions::SetupJenkinsAction::USED_ENV_NAMES +
          Fastlane::Actions::SetupJenkinsAction.available_options.map(
            &:env_name
          )
      ...
      it "doesn't work outside CI" do
        ...
        expect(UI).to receive(:important).with(
                    'Not executed by Continuous Integration system.'
                  )

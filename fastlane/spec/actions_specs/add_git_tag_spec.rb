  ...
  describe Fastlane::FastFile do
    describe 'Add Git Tag Integration' do
      ...
      it 'generates a tag based on existing context' do
        ...
        expect(result).to eq(
                    "git tag -am #{message.shellescape} #{tag.shellescape}"
                  )
      end
      ...
      it 'allows you to force the tag creation' do
        ...
        expect(result).to eq(
                    "git tag -am #{message.shellescape} --force #{tag
                      .shellescape}"
                  )
      end
      ...
      it 'allows you to specify the commit where to add the tag' do
        ...
        expect(result).to eq(
                    "git tag -am #{message.shellescape} #{tag
                      .shellescape} #{commit}"
                  )
      end
      ...
      it "allows you to sign the tag using the default e-mail address's key." do
        ...
        expect(result).to eq(
                    "git tag -am #{message.shellescape} -s #{tag.shellescape}"
                  )
      end
    end
  end

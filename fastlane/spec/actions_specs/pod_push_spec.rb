  ...
  describe Fastlane::FastFile do
    describe 'Pod Push action' do
      ...
      it 'generates the correct pod push command with a path parameter' do
        ...
        expect(result).to eq(
                    "pod trunk push './fastlane/spec/fixtures/podspecs/test.podspec'"
                  )
      end
      ...
      it 'generates the correct pod push command with a repo parameter' do
        ...
        expect(result).to eq(
                    "pod repo push MyRepo './fastlane/spec/fixtures/podspecs/test.podspec'"
                  )
      end
      ...
      it 'generates the correct pod push command with a repo parameter with the swift version flag' do
        ...
        expect(result).to eq(
                    "pod repo push MyRepo './fastlane/spec/fixtures/podspecs/test.podspec' --swift-version=4.0"
                  )
      end
      ...
      it 'generates the correct pod push command with a repo parameter with the allow warnings and use libraries flags' do
        ...
        expect(result).to eq(
                    "pod repo push MyRepo './fastlane/spec/fixtures/podspecs/test.podspec' --allow-warnings --use-libraries"
                  )
      end
      ...
      it 'generates the correct pod push command with a repo parameter with the skip import validation and skip tests flags' do
        ...
        expect(result).to eq(
                    "pod repo push MyRepo './fastlane/spec/fixtures/podspecs/test.podspec' --skip-import-validation --skip-tests"
                  )
      end
      ...
      it 'generates the correct pod push command with a json file' do
        ...
        expect(result).to eq(
                    "pod repo push MyRepo './fastlane/spec/fixtures/podspecs/test.podspec.json'"
                  )
      end
      ...
      it 'errors if the path file does not end with .podspec or .podspec.json' do
        ...
        expect { ff.runner.execute(:test) }.to raise_error(
                    'File must be a `.podspec` or `.podspec.json`'
                  )
      end

describe Fastlane do
  describe Fastlane::FastFile do
    describe 'xcversion integration' do
      after(:each) { ENV.delete('DEVELOPER_DIR') }
      ...
      context 'when a version requirement is specified' do
        ...
        let(:v7_2_1) do
          double(
            'XcodeInstall::Xcode',
            version: '7.2.1', path: '/Test/Xcode7.2.1'
          )
        end
            ...
            expect do
              Fastlane::FastFile.new.parse(
                ...
                .execute(:test)
                        ...
                        "The requirement '= aaaa' is not a valid RubyGems style requirement"
                      )
          end
        end
        ...
        context 'with a valid requirement' do
          before do
            ...
            allow(installer).to receive(:installed_versions).and_return(
                       [v7_2, v7_2_1, v7_3]
                     )
            allow(XcodeInstall::Installer).to receive(:new).and_return(
                       installer
                     )
          end
          ...
          context 'with a specific requirement' do
            it 'selects the correct version of xcode' do
              ...
              expect(ENV['DEVELOPER_DIR']).to eq(
                          File.join(v7_2.path, 'Contents/Developer')
                        )
            end
          end
          ...
          context 'with a pessimistic requirement' do
            it 'selects the correct version of xcode' do
              ...
              expect(ENV['DEVELOPER_DIR']).to eq(
                          File.join(v7_2_1.path, 'Contents/Developer')
                        )
            end
          end
              ...
              expect do
                Fastlane::FastFile.new.parse(
                  ...
                  .execute(:test)
                          ...
                          "Cannot find an installed Xcode satisfying '= 7.1'"
                        )
            end
          end
        end

  ...
  describe Fastlane::FastFile do
    describe 'Increment Version Number Integration' do
      it 'it increments all targets patch version number' do
        ...
        expect(
          Fastlane::Actions.lane_context[
            Fastlane::Actions::SharedValues::VERSION_NUMBER
          ]
        ).to match(/cd .* && agvtool new-marketing-version 1.0.1/)
      end
      ...
      it 'it increments all targets minor version number' do
        ...
        ).to match(/cd .* && agvtool new-marketing-version 1.1.0/)
      end
      ...
      it 'it increments all targets minor version major' do
        ...
        ).to match(/cd .* && agvtool new-marketing-version 2.0.0/)
      end
      ...
      it 'pass a custom version number' do
        ...
        ).to match(/cd .* && agvtool new-marketing-version 1.4.3/)
      end
      ...
      it 'prefers a custom version number over a boring version bump' do
        ...
        ).to match(/cd .* && agvtool new-marketing-version 1.77.3/)
      end
      ...
      it 'automatically removes new lines from the version number' do
        ...
        ).to end_with('&& agvtool new-marketing-version 1.77.3')
      end
        ...
        expect do
          Fastlane::FastFile.new.parse(
            ...
            .execute(:test)
                    ...
                    'Your current version (00000) does not respect the format A.B.C'
                  )
      end
    end
  end

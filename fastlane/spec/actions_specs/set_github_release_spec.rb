  ...
  describe Fastlane::FastFile do
    describe 'set_github_release' do
      it 'sends and receives the right content from GitHub' do
        stub_request(
          :post,
          'https://api.github.com/repos/czechboy0/czechboy0.github.io/releases'
        )
          .with(
          body:
            '{\"tag_name\":\"tag33\",\"name\":\"Awesome Release\",\"body\":\"Bunch of new things :+1:\",\"draft\":false,\"prerelease\":false,\"target_commitish\":\"test\"}',
          headers: {
          ...
          body:
            File.read(
              './fastlane/spec/fixtures/requests/github_create_release_response.json'
            ),
          headers: {}
        )
        ...
        expect(result['html_url']).to eq(
                    'https://github.com/czechboy0/czechboy0.github.io/releases/tag/tag33'
                  )
      ...
      it 'can use a generated changelog as the description' do
        stub_request(
          ...
          .with(
          body:
            '{\"tag_name\":\"tag33\",\"name\":\"Awesome Release\",\"body\":\"autogenerated changelog\",\"draft\":false,\"prerelease\":false,\"target_commitish\":\"test\"}',
          headers: {
            'Authorization' => 'Basic MTIzNDVhYmNkZQ==',
            'Host' => 'api.github.com:443',
            'User-Agent' => 'fastlane-github_api'
      ...
      it 'prefers an explicit description over a generated changelog' do
        stub_request(
          ...
          .with(
          body:
            '{\"tag_name\":\"tag33\",\"name\":\"Awesome Release\",\"body\":\"explicitly provided\",\"draft\":false,\"prerelease\":false,\"target_commitish\":\"test\"}',
          headers: {
            'Authorization' => 'Basic MTIzNDVhYmNkZQ==',
            'Host' => 'api.github.com:443',
            'User-Agent' => 'fastlane-github_api'

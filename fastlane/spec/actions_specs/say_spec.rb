describe Fastlane do
  describe Fastlane::FastFile do
    describe 'Say Integration' do
      ...
      describe 'muted' do
        before { stub_const('ENV', { 'SAY_MUTE' => 'true' }) }

        it 'works with array' do
          expect(Fastlane::UI).to receive(:message).with('Hi Felix Good Job')
                      .and_call_original
        ...
        it 'works with string' do
          expect(Fastlane::UI).to receive(:message).with('Hi Josh Good Job')
                      .and_call_original

  ...
  describe Fastlane::FastFile do
    describe 'Carthage Integration' do
        ...
        expect do
          Fastlane::FastFile.new.parse(
            ...
            .execute(:test)
                    ...
                    'Please pass a valid command. Use one of the following: build, bootstrap, update, archive'
                  )
      end
        ...
        expect do
          Fastlane::FastFile.new.parse(
            ...
            .execute(:test)
                    ...
                    'Please pass a valid platform. Use one of the following: all, iOS, Mac, tvOS, watchOS'
                  )
      end
        ...
        expect do
          Fastlane::FastFile.new.parse(
            ...
            .execute(:test)
                    ...
                    'Please pass a valid build configuration. You can review the list of configurations for this project using the command: xcodebuild -list'
                  )
      end
      ...
      it 'sets the toolchain to Swift_2_3' do
        ...
        expect(result).to eq(
                    'carthage bootstrap --toolchain com.apple.dt.toolchain.Swift_2_3'
                  )
      end
      ...
      it 'sets the project directory to other and the toolchain to Swift_2_3' do
        ...
        expect(result).to eq(
                    'carthage bootstrap --toolchain com.apple.dt.toolchain.Swift_2_3 --project-directory other'
                  )
      end
      ...
      it 'use custom derived data' do
        ...
        expect(result).to eq(
                    "carthage bootstrap --derived-data #{path.shellescape}"
                  )
      end
      ...
      it 'use custom executable' do
        ...
        expect(result).to eq('custom_carthage bootstrap')
      end
      ...
      it 'updates with a single dependency' do
        ...
        expect(result).to eq('carthage update TestDependency')
      end
      ...
      it 'updates with multiple dependencies' do
        ...
        expect(result).to eq('carthage update TestDependency1 TestDependency2')
      end
      ...
      it 'builds with a single dependency' do
        ...
        expect(result).to eq('carthage build TestDependency')
      end
      ...
      it 'builds with multiple dependencies' do
        ...
        expect(result).to eq('carthage build TestDependency1 TestDependency2')
      end
      ...
      it 'bootstraps with a single dependency' do
        ...
        expect(result).to eq('carthage bootstrap TestDependency')
      end
      ...
      it 'bootstraps with multiple dependencies' do
        ...
        expect(result).to eq(
                    'carthage bootstrap TestDependency1 TestDependency2'
                  )
      end
            ...
            expect do
              Fastlane::FastFile.new.parse(
                ...
                .execute(:test)
                        ...
                        "Frameworks option is available only for 'archive' command."
                      )
          end
        end
            ...
            expect do
              Fastlane::FastFile.new.parse(
                ...
                .execute(:test)
                        ...
                        "Output option is available only for 'archive' command."
                      )
          end
        end
            ...
            expect do
              Fastlane::FastFile.new.parse(
                ...
                .execute(:test)
                        ...
                        "Log path option is available only for 'build', 'bootstrap', and 'update' command."
                      )
          end
        end

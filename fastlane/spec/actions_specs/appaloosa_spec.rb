  ...
  describe Fastlane::FastFile do
    ...
    describe 'Appaloosa Integration' do
      ...
      context 'without ipa or apk' do
        let(:appaloosa_lane) do
          "lane :test do appaloosa({ api_token: 'xxx', store_id:  'xxx' }) end"
        end
      ...
      context 'when upload_service returns an error' do
        before do
          stub_request(
            :get,
            "#{APPALOOSA_SERVER}/upload_services/presign_form?api_key=xxx&file=Fastfile1&group_ids=&store_id=556"
          )
            .to_return(
            status: 200,
            body: '{ "errors": "A group id is incorrect" }',
            headers: {}
          )
        end
      ...
      context 'when get_s3_url return a 404' do
        ...
        let(:presign_payload) do
          {
            s3_sign: presign_s3_key, path: 'https://appaloosa.com/file.apk'
          }.to_json
        end
        let(:expect_error) do
        ...
        before do
          ...
          stub_request(:put, 'http://appaloosa.com/test').to_return(status: 200)
          stub_request(
            :get,
            "#{APPALOOSA_SERVER}/556/upload_services/url_for_download?api_key=xxx&key=https://appaloosa.com/file.apk&store_id=556"
          )
      ...
      context 'with valid parameters' do
        ...
        let(:upload_services_payload) do
          {
            ...
            key:
              'https://appaloosa.com/fastlane/mqkaoev2/iphone6-screenshot2.png'
          }.to_json
        end
        ...
        before do
          ...
          stub_request(:put, 'http://appaloosa.com/test').to_return(

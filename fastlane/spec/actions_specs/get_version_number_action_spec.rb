describe Fastlane do
  describe Fastlane::FastFile do
    describe 'Get Version Number Integration' do
      ...
      it "gets the correct version number for 'TargetA'",
         requires_xcodeproj: true do
        result =
      ...
      it "gets the correct version number for 'TargetATests'",
         requires_xcodeproj: true do
        result =
          Fastlane::FastFile.new.parse(
            "lane :test do
      ...
      it "gets the correct version number for 'TargetB'",
         requires_xcodeproj: true do
        result =
          Fastlane::FastFile.new.parse(
            "lane :test do
      ...
      it "gets the correct version number for 'TargetBTests'",
         requires_xcodeproj: true do
        result =
          Fastlane::FastFile.new.parse(
            "lane :test do
      ...
      it "gets the correct version number for 'TargetC_internal'",
         requires_xcodeproj: true do
        result =
          Fastlane::FastFile.new.parse(
            "lane :test do
      ...
      it "gets the correct version number for 'TargetC_production'",
         requires_xcodeproj: true do
        result =
          Fastlane::FastFile.new.parse(
            "lane :test do
      ...
      it "gets the correct version number for 'SampleProject_tests'",
         requires_xcodeproj: true do
        result =
          Fastlane::FastFile.new.parse(
            "lane :test do
      ...
      it 'gets the correct version number with no target specified (and one target)',
         requires_xcodeproj: true do
        allow_any_instance_of(Xcodeproj::Project).to receive(:targets)
      ...
      it 'gets the correct version number with no target specified (and one target and multiple test targets)',
         requires_xcodeproj: true do
        allow_any_instance_of(Xcodeproj::Project).to receive(:targets)
                                   .and_wrap_original do |m, *args|
          targets = m.call(*args)
          targets.select do |target|
            target.name == 'TargetA' || target.name == 'TargetATests' ||
              target.name == 'TargetBTests'
          end
        end
      ...
      it 'raises if one target and specified wrong target name',
         requires_xcodeproj: true do
        allow_any_instance_of(Xcodeproj::Project).to receive(:targets)
                                   .and_wrap_original do |m, *args|
          [m.call(*args).first]
          ...
          result =
            ...
            get_version_number(xcodeproj: '#{path}', target: 'ThisIsNotATarget')
              ...
              .execute(:test)
                    ...
                    "Cannot find target named 'ThisIsNotATarget'"
                  )
      end

      it 'raises if in non-interactive mode with no target',
         requires_xcodeproj: true do
        expect do
          result =
            Fastlane::FastFile.new.parse(
      ...
      it 'raises if in non-interactive mode if cannot infer configuration',
         requires_xcodeproj: true do
        expect do
          result =
            Fastlane::FastFile.new.parse(
      ...
      it 'gets correct version for different configurations',
         requires_xcodeproj: true do
        result =
          Fastlane::FastFile.new.parse(
            "lane :test do

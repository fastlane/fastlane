  ...
  describe Fastlane::FastFile do
    describe 'create_pull_request' do
      let(:response_body) do
        File.read(
          './fastlane/spec/fixtures/requests/github_create_pull_request_response.json'
        )
      end
      ...
      context 'successful' do
        before do
          stub_request(
            :post,
            'https://api.github.com/repos/fastlane/fastlane/pulls'
          )
            .with(
            body:
              '{"title":"test PR","head":"git rev-parse --abbrev-ref HEAD","base":"master"}',
            headers: {
          ...
          stub_request(
            :patch,
            "https://api.github.com/repos/fastlane/fastlane/issues/#{number}"
          )
            .with(

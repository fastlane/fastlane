  ...
  describe Fastlane::ErbTemplateHelper do
      ...
      it 'raises an error if file does not exist' do
        expect do
          Fastlane::ErbTemplateHelper.load('invalid_name')
                    ...
                    "Could not find template at path '#{Fastlane::ROOT}/lib/assets/invalid_name.erb'"
                  )
      end
    ...
    describe 'render_template' do
      ...
      it 'renders with defined trim_mode' do
        template =
          File.read('./fastlane/spec/fixtures/templates/trim_mode_template.erb')
        rendered_template =
          Fastlane::ErbTemplateHelper.render(template, {}, '-')

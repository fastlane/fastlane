  ...
  describe Fastlane::PluginManager do
    ...
    describe "Error handling of invalid plugins" do
      ...
      it "shows an appropriate error message when an action is not available, which is not a plugin" do
        ...
        end.to raise_exception("Could not find action, lane or variable 'my_custom_plugin'. Check out the README for more details: https://github.com/fastlane/fastlane/tree/master/fastlane")
      end
    end
  end
end

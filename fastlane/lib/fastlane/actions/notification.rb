      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :app_icon,
                                       description: "The URL of an image to display instead of the application icon (Mavericks+ only, ignored with terminal-notifier 3.x)",
                                       optional: true),
          FastlaneCore::ConfigItem.new(key: :content_image,
                                       description: "The URL of an image to display attached to the notification (Mavericks+ only, must be a local path with terminal-notifier 3.x)",
                                       optional: true),

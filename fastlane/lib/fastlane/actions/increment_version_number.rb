    ...
    class IncrementVersionNumberAction < Action
      ...
      def self.run(params)
        ...
        if params[:version_number]
          UI.verbose("Your current version (#{current_version}) does not respect the format A.B.C") unless current_version.match?(/\d.\d.\d/)
          ...
          if Helper.test?
            ...
            UI.user_error!("Your current version (#{current_version}) does not respect the format A.B.C") unless current_version.match?(/\d+.\d+.\d+/)

    ...
    class ResignAction < Action
      def self.run(params)
        ...
        if Sigh::Resign.resign(
           ...
           params[:version],
           params[:display_name],
           params[:short_version],
           params[:bundle_version],
           params[:bundle_id],
           params[:use_app_entitlements],
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(
            ...
            conflicting_options: %i[use_app_entitlements],
            is_string: true,
            optional: true
          ),
          FastlaneCore::ConfigItem.new(
              ...
              proc do |value|
                ...
                files.each do |file|
                  unless File.exist?(file)
                    UI.user_error!(
                      "Couldn't find provisiong profile at path '#{file}'"
                    )
                  end
                end
              end
          ...
          FastlaneCore::ConfigItem.new(
            ...
            conflicting_options: %i[short_version bundle_version],
            is_string: true,
            optional: true
          ),
          FastlaneCore::ConfigItem.new(
          ...
          FastlaneCore::ConfigItem.new(
            ...
            conflicting_options: %i[entitlements],
            is_string: false,
            optional: true
          ),
          FastlaneCore::ConfigItem.new(

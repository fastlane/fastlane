module Fastlane
  module Actions
    class ImportFromGitAction < Action
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(
            key: :version,
            description:
              'The version to checkout on the respository. Optimistic match operator or multiple conditions can be used to select the latest version within constraints',
            default_value: nil,
            is_string: false,
            optional: true
          )
      ...
      def self.authors
        %w[fabiomassimo KrauseFx Liquidsoul]
      end

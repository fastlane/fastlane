module Fastlane
  module Actions
    class GooglePlayAabVersionCodesAction < Action
      ...
      def self.run(params)
        ...
        version_codes = Supply::Reader.new.aab_version_codes || []
      ...
      def self.description
        "Retrieves version codes for a Google Play aab"
      end
      ...
      def self.return_value
        "Array of integers representing the version codes for the given Google Play aab"
      end

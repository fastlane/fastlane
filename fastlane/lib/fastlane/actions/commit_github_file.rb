  ...
  module Actions
    ...
    class CommitGithubFileAction < Action
      ...
      def self.details
        ...
        (get one from [https://github.com/settings/tokens/new](https://github.com/settings/tokens/new)), the repository name and the relative file path from the root git project.

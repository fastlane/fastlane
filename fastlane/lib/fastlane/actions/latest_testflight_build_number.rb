  ...
  module Actions
    ...
    class LatestTestflightBuildNumberAction < Action
      def self.run(params)
        ...
        Actions.lane_context[SharedValues::LATEST_TESTFLIGHT_BUILD_NUMBER] =
          build_number
      end
      ...
      def self.available_options
        ...
        [
          ...
          FastlaneCore::ConfigItem.new(
            ...
            verify_block:
              proc do |value|
                unless "'ios', 'appletvos'".include?(value)
                  UI.user_error!('The platform can only be ios, or appletvos')
                end
              end
          ),
          FastlaneCore::ConfigItem.new(

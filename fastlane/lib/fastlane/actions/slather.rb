  ...
  module Actions
    ...
    class SlatherAction < Action
      ...
      def self.run(params)
        ...
        # require bundler
        Actions.verify_gem!('slather') unless params[:use_bundle_exec]
      ...
      def self.validate_params!(params)
        if params[:configuration]
          unless configuration_available?
            UI.user_error!(
        ...
        if params[:proj] || has_config_file
          ...
          UI.user_error!(
            'You have to provide a project with `:proj` or use a .slather.yml'
          )
        end
      end
        ...
        ARGS_MAP.each do |key, cli_param|
          ...
          if cli_value
            if cli_value.kind_of?(TrueClass)
              ...
              command <<
                cli_value.map { |path| "#{cli_param} #{path.shellescape}" }
            end
          else
            next
          end
      ...
      def self.available_options
        [
          FastlaneCore::ConfigItem.new(
            key: :build_directory,
            env_name: 'FL_SLATHER_BUILD_DIRECTORY',
          ...
          FastlaneCore::ConfigItem.new(
            key: :proj,
            env_name: 'FL_SLATHER_PROJ',
            # The name of the environment variable
            description: 'The project file that slather looks at',
            verify_block:
              proc do |# a short description of this parameter
              value|
                unless value && !value.empty?
                  UI.user_error!(
                    "No project file specified, pass using `proj: 'Project.xcodeproj'`"
                  )
                end
              end,
            optional: true
          ...
          FastlaneCore::ConfigItem.new(
            key: :configuration,
            env_name: 'FL_SLATHER_CONFIGURATION',
            # The name of the environment variable
            description:
          ...
          FastlaneCore::ConfigItem.new(
            key: :input_format,
            env_name: 'FL_SLATHER_INPUT_FORMAT',
            # The name of the environment variable
          ...
          FastlaneCore::ConfigItem.new(
            key: :buildkite,
            env_name: 'FL_SLATHER_BUILDKITE_ENABLED',
            # The name of the environment variable
          ...
          FastlaneCore::ConfigItem.new(
            key: :teamcity,
            env_name: 'FL_SLATHER_TEAMCITY_ENABLED',
            # The name of the environment variable
          ...
          FastlaneCore::ConfigItem.new(
            key: :jenkins,
            env_name: 'FL_SLATHER_JENKINS_ENABLED',
            # The name of the environment variable
          ...
          FastlaneCore::ConfigItem.new(
            key: :travis_pro,
            env_name: 'FL_SLATHER_TRAVIS_PRO_ENABLED',
            # The name of the environment variable

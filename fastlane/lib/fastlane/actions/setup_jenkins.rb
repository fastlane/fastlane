    ...
    class SetupJenkinsAction < Action
      ...
      def self.run(params)
        ...
        FastlaneCore::PrintTable.print_values(
          config: params, title: 'Summary for Setup Jenkins Action'
        )
        ...
        if params[:output_directory]
          ...
          UI.message(
            "Set output directory path to: \"#{output_directory_path}\"."
          )
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(
            key: :add_keychain_to_search_list,

module Fastlane
  class ConfigurationHelper
    def self.parse(action, params)
      ...
      first_element = (available_options || []).first

      if first_element && first_element.kind_of?(FastlaneCore::ConfigItem)
        # default use case
        return FastlaneCore::Configuration.create(available_options, params)
      elsif first_element
        ...
        FastlaneCore::Configuration.create(available_options, {})

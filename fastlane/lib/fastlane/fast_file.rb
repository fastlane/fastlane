...
class String
  ...
  def fastlane_version_number_from_tag
    sub(/^v/, "")
  end
end
...
module Gem
  class Version
    def self.from_tag(tag)
      new(tag.fastlane_version_number_from_tag)
    end

    def self.tag_correct?(tag)
      correct?(tag.fastlane_version_number_from_tag)
    end
  end
end
...
module Fastlane
  class FastFile
      ...
      Actions.execute_action('import_from_git') do
        ...
        Dir.mktmpdir("fl_clone") do |tmp_path|
          ...
          unless version.nil?
            ...
            checkout_param = all_tags.select { |t| req =~ Gem::Version.from_tag(t) }.last
    ...
    def fetch_remote_tags(folder: nil)
      ...
      return git_tags
             .select { |tag| Gem::Version.tag_correct?(tag) }
             .sort_by { |tag| Gem::Version.from_tag(tag) }
    end

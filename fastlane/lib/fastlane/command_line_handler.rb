  ...
  class CommandLineHandler
    ...
    def self.handle(args, options)
      ...
      if FastlaneCore::FastlaneFolder.swift?
        ...
        enable_runner_upgrades = options.enable_runner_upgrades || false
        swift_server_port = options.swift_server_port
        Fastlane::SwiftLaneManager.cruise_lane(lane, lane_parameters, dot_env, disable_runner_upgrades: disable_runner_upgrades, enable_runner_upgrades: enable_runner_upgrades, swift_server_port: swift_server_port)
      else

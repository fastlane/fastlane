import Foundation
@discardableResult func adb(serial: String = "", command: String? = nil, adbPath: String = "adb") -> String {
...
func addGitTag(tag: String? = nil, grouping: String = "builds", prefix🚀: String = "", buildNumber: String, message: String? = nil, commit: String? = nil, force: Bool = false, sign: Bool = false) {
...
func appStoreBuildNumber(initialBuildNumber: String = "1", appIdentifier: String, username: String, teamId: String? = nil, live: Bool = true, version: String? = nil, platform: String = "ios", teamName: String? = nil) {
...
func appaloosa(binary: String, apiToken: String, storeId: String, groupIds: String = "", screenshots: String, locale: String = "en-US", device: String? = nil, description: String? = nil) {
...
func appetize(apiToken: String, url: String? = nil, platform: String = "ios", path: String? = nil, publicKey: String? = nil, note: String? = nil) {
...
func appetizeViewingUrlGenerator(publicKey: String, baseUrl: String = "https://appetize.io/embed", device: String = "iphone5s", scale: String? = nil, orientation: String = "portrait", language: String? = nil, color: String = "black", launchUrl: String? = nil, osVersion: String? = nil, params: String? = nil, proxy: String? = nil) {
...
func appium(platform: String, specPath: String, appPath: String, invokeAppiumServer: Bool = true, host: String = "0.0.0.0", port: String = "4723", appiumPath: String? = nil, caps: String? = nil) {
...
func artifactory(file: String, repo: String, repoPath: String, endpoint: String, username: String, password: String, properties: String = "{}", sslPemFile: String? = nil, sslVerify: Bool = true, proxyUsername: String? = nil, proxyPassword: String? = nil, proxyAddress: String? = nil, proxyPort: String? = nil) {
...
func automaticCodeSigning(path: String, useAutomaticSigning: Bool = false, teamId: String? = nil, targets: [String]? = nil) {
...
func backupXcarchive(xcarchive: String, destination: String, zip: Bool = true, zipFilename: String? = nil, versioned: Bool = true) {
  let command = RubyCommand(commandID: "", methodName: "backup_xcarchive", className: nil, args: [RubyCommand.Argument(name: "xcarchive", value: xcarchive), RubyCommand.Argument(name: "destination", value: destination), RubyCommand.Argument(name: "zip", value: zip), RubyCommand.Argument(name: "zip_filename", value: zipFilename), RubyCommand.Argument(name: "versioned", value: versioned)])
  _ = runner.executeCommand(command)
}
func badge(dark: String? = nil, custom: String? = nil, noBadge: String? = nil, shield: String? = nil, alpha: String? = nil, path: String = ".", shieldIoTimeout: String? = nil, glob: String? = nil, alphaChannel: String? = nil, shieldGravity: String? = nil, shieldNoResize: String? = nil) {
...
func bundleInstall(binstubs: String? = nil, clean: Bool = false, fullIndex: Bool = false, gemfile: String? = nil, jobs: String? = nil, local: Bool = false, deployment: Bool = false, noCache: Bool = false, noPrune: Bool = false, path: String? = nil, system: Bool = false, quiet: Bool = false, retry: String? = nil, shebang: String? = nil, standalone: String? = nil, trustPolicy: String? = nil, without: String? = nil, with: String? = nil) {
...
func carthage(command: String = "bootstrap", dependencies: [String] = [], useSsh: String? = nil, useSubmodules: String? = nil, useBinaries: String? = nil, noBuild: String? = nil, noSkipCurrent: String? = nil, derivedData: String? = nil, verbose: String? = nil, platform: String? = nil, cacheBuilds: Bool = false, frameworks: [String] = [], output: String? = nil, configuration: String? = nil, toolchain: String? = nil, projectDirectory: String? = nil) {
...
func cert(development: Bool = false, force: Bool = false, username: String, teamId: String? = nil, teamName: String? = nil, outputPath: String = ".", keychainPath: String, keychainPassword: String? = nil, platform: String = "ios") {
...
@discardableResult func changelogFromGitCommits(between: String? = nil, commitsCount: Int? = nil, pretty: String = "%B", dateFormat: String? = nil, ancestryPath: Bool = false, tagMatchPattern: String? = nil, matchLightweightTag: Bool = true, includeMerges: String? = nil, mergeCommitFiltering: String = "include_merges") -> String {
...
func chatwork(apiToken: String, message: String, roomid: String, success: Bool = true) {
...
func cloc(binaryPath: String = "/usr/local/bin/cloc", excludeDir: String? = nil, outputDirectory: String = "build", sourceDirectory: String = "", xml: Bool = true) {
...
func cocoapods(clean: Bool = true, integrate: Bool = true, repoUpdate: Bool = false, silent: Bool = false, verbose: Bool = false, ansi: Bool = true, useBundleExec: Bool = true, podfile: String? = nil, errorCallback: ((String) -> Void) = {_ in }, tryRepoUpdateOnError: Bool = true) {
  let command = RubyCommand(commandID: "", methodName: "cocoapods", className: nil, args: [RubyCommand.Argument(name: "clean", value: clean), RubyCommand.Argument(name: "integrate", value: integrate), RubyCommand.Argument(name: "repo_update", value: repoUpdate), RubyCommand.Argument(name: "silent", value: silent), RubyCommand.Argument(name: "verbose", value: verbose), RubyCommand.Argument(name: "ansi", value: ansi), RubyCommand.Argument(name: "use_bundle_exec", value: useBundleExec), RubyCommand.Argument(name: "podfile", value: podfile), RubyCommand.Argument(name: "error_callback", value: errorCallback, type: .stringClosure), RubyCommand.Argument(name: "try_repo_update_on_error", value: tryRepoUpdateOnError)])
  _ = runner.executeCommand(command)
}
@discardableResult func commitGithubFile(repositoryName: String, serverUrl: String = "https://api.github.com", apiToken: String, branch: String = "master", path: String, message: String? = nil, secure: Bool = true) -> [String : String] {
...
func commitVersionBump(message: String? = nil, xcodeproj: String? = nil, force: Bool = false, settings: Bool = false, ignore: String? = nil, include: [String] = []) {
  let command = RubyCommand(commandID: "", methodName: "commit_version_bump", className: nil, args: [RubyCommand.Argument(name: "message", value: message), RubyCommand.Argument(name: "xcodeproj", value: xcodeproj), RubyCommand.Argument(name: "force", value: force), RubyCommand.Argument(name: "settings", value: settings), RubyCommand.Argument(name: "ignore", value: ignore), RubyCommand.Argument(name: "include", value: include)])
  _ = runner.executeCommand(command)
}
func copyArtifacts(keepOriginal: Bool = true, targetPath: String = "artifacts", artifacts: [String] = [], failOnMissing: Bool = false) {
...
func crashlytics(ipaPath: String? = nil, apkPath: String? = nil, crashlyticsPath: String? = nil, apiToken: String, buildSecret: String, notesPath: String? = nil, notes: String? = nil, groups: String? = nil, emails: String? = nil, notifications: Bool = true, debug: Bool = false) {
...
func createKeychain(name: String? = nil, path: String? = nil, password: String, defaultKeychain: Bool = false, unlock: Bool = false, timeout: String = "300", lockWhenSleeps: Bool = false, lockAfterTimeout: Bool = false, addToSearchList: Bool = true) {
...
func danger(useBundleExec: Bool = true, verbose: Bool = false, dangerId: String? = nil, dangerfile: String? = nil, githubApiToken: String? = nil, failOnErrors: Bool = false, newComment: Bool = false, base: String? = nil, head: String? = nil) {
...
func deleteKeychain(name: String? = nil, keychainPath: String? = nil) {
...
func downloadDsyms(username: String, appIdentifier: String, teamId: String? = nil, teamName: String? = nil, platform: String = "ios", version: String? = nil, buildNumber: String? = nil, outputDirectory: String? = nil) {
...
func dsymZip(archivePath: String? = nil, dsymPath: String? = nil, all: Bool = false) {
...
func ensureNoDebugCode(text: String, path: String = ".", extension🚀: String? = nil, extensions: String? = nil, exclude: String? = nil, excludeDirs: [String]? = nil) {
...
@discardableResult func environmentVariable(set🚀: [String : String]? = nil, get🚀: String? = nil, remove: String? = nil) -> String {
...
func frameit(white: String? = nil, silver: String? = nil, roseGold: String? = nil, gold: String? = nil, forceDeviceType: String? = nil, useLegacyIphone5s: Bool = false, useLegacyIphone6s: Bool = false, path: String = "./") {
...
func getGithubRelease(url: String, serverUrl: String = "https://api.github.com", version: String, apiToken: String? = nil) {
...
func getVersionNumber(xcodeproj: String? = nil, scheme: String? = nil, target: String? = nil) {
...
func gitAdd(path: String? = nil, pathspec: String? = nil) {
...
func githubApi(serverUrl: String = "https://api.github.com", apiToken: String, httpMethod: String = "GET", body: String = "{}", rawBody: String? = nil, path: String? = nil, url: String? = nil, errorHandlers: String = "{}", headers: String = "{}", secure: Bool = true) {
...
func googlePlayTrackVersionCodes(packageName: String, track: String = "production", key: String? = nil, issuer: String? = nil, jsonKey: String? = nil, jsonKeyData: String? = nil, rootUrl: String? = nil) {
...
func hgCommitVersionBump(message: String = "Version Bump", xcodeproj: String? = nil, force: Bool = false, testDirtyFiles: String = "file1, file2", testExpectedFiles: String = "file1, file2") {
...
func hgPush(force: Bool = false, destination: String = "") {
...
func hipchat(message: String = "", channel: String, apiToken: String, customColor: String? = nil, success: Bool = true, version: String, notifyRoom: Bool = false, apiHost: String = "api.hipchat.com", messageFormat: String = "html", includeHtmlHeader: Bool = true, from: String = "fastlane") {
...
func ifttt(apiKey: String, eventName: String, value1: String? = nil, value2: String? = nil, value3: String? = nil) {
...
func importCertificate(keychainName: String, keychainPath: String? = nil, keychainPassword: String? = nil, certificatePath: String, certificatePassword: String = "", logOutput: Bool = false) {
...
@discardableResult func incrementVersionNumber(bumpType: String = "patch", versionNumber: String? = nil, xcodeproj: String? = nil) -> String {
...
func installOnDevice(extra: String? = nil, deviceId: String? = nil, skipWifi: String? = nil, ipa: String? = nil) {
...
func installXcodePlugin(url: String, github: String? = nil) {
...
func installr(apiToken: String, ipa: String, notes: String? = nil, notify: String? = nil, add: String? = nil) {
...
func ipa(workspace: String? = nil, project: String? = nil, configuration: String? = nil, scheme: String? = nil, clean: String? = nil, archive: String? = nil, destination: String? = nil, embed: String? = nil, identity: String? = nil, sdk: String? = nil, ipa: String? = nil, xcconfig: String? = nil, xcargs: String? = nil) {
...
@discardableResult func latestTestflightBuildNumber(live: Bool = false, appIdentifier: String, username: String, version: String? = nil, platform: String = "ios", initialBuildNumber: String = "1", teamId: String? = nil, teamName: String? = nil) -> Int {
...
func mailgun(mailgunSandboxDomain: String? = nil, mailgunSandboxPostmaster: String? = nil, mailgunApikey: String? = nil, postmaster: String, apikey: String, to: String, from: String = "Mailgun Sandbox", message: String, subject: String = "fastlane build", success: Bool = true, appLink: String, ciBuildLink: String? = nil, templatePath: String? = nil, replyTo: String? = nil, attachment: String? = nil) {
...
func makeChangelogFromJenkins(fallbackChangelog: String = "", includeCommitBody: Bool = true) {
...
func nexusUpload(file: String, repoId: String, repoGroupId: String, repoProjectName: String, repoProjectVersion: String, repoClassifier: String? = nil, endpoint: String, mountPath: String = "/nexus", username: String, password: String, sslVerify: Bool = true, verbose: Bool = false, proxyUsername: String? = nil, proxyPassword: String? = nil, proxyAddress: String? = nil, proxyPort: String? = nil) {
...
func notification(title: String = "fastlane", subtitle: String? = nil, message: String, sound: String? = nil, activate: String? = nil, appIcon: String? = nil, contentImage: String? = nil, open: String? = nil, execute: String? = nil) {
...
func oclint(oclintPath: String = "oclint", compileCommands: String = "compile_commands.json", selectReqex: String? = nil, selectRegex: String? = nil, excludeRegex: String? = nil, reportType: String = "html", reportPath: String? = nil, listEnabledRules: Bool = false, rc: String? = nil, thresholds: String? = nil, enableRules: String? = nil, disableRules: String? = nil, maxPriority1: String? = nil, maxPriority2: String? = nil, maxPriority3: String? = nil, enableClangStaticAnalyzer: Bool = false, enableGlobalAnalysis: Bool = false, allowDuplicatedViolations: Bool = false) {
...
func onesignal(authToken: String, appName: String, androidToken: String? = nil, apnsP12: String? = nil, apnsP12Password: String? = nil, apnsEnv: String = "production") {
...
func pem(development: Bool = false, generateP12: Bool = true, activeDaysLimit: String = "30", force: Bool = false, savePrivateKey: Bool = true, appIdentifier: String, username: String, teamId: String? = nil, teamName: String? = nil, p12Password: String = "", pemName: String? = nil, outputPath: String = ".", newProfile: String? = nil) {
...
func podLibLint(useBundleExec: Bool = true, verbose: String? = nil, allowWarnings: String? = nil, sources: String? = nil, useLibraries: Bool = false, failFast: Bool = false, private🚀: Bool = false, quick: Bool = false) {
...
func podPush(path: String? = nil, repo: String? = nil, allowWarnings: String? = nil, useLibraries: String? = nil, sources: String? = nil, swiftVersion: String? = nil, verbose: Bool = false) {
  let command = RubyCommand(commandID: "", methodName: "pod_push", className: nil, args: [RubyCommand.Argument(name: "path", value: path), RubyCommand.Argument(name: "repo", value: repo), RubyCommand.Argument(name: "allow_warnings", value: allowWarnings), RubyCommand.Argument(name: "use_libraries", value: useLibraries), RubyCommand.Argument(name: "sources", value: sources), RubyCommand.Argument(name: "swift_version", value: swiftVersion), RubyCommand.Argument(name: "verbose", value: verbose)])
  _ = runner.executeCommand(command)
}
func podioItem(clientId: String, clientSecret: String, appId: String, appToken: String, identifyingField: String, identifyingValue: String, otherFields: String? = nil) {
...
@discardableResult func prompt(text: String = "Please enter some text: ", ciInput: String = "", boolean: Bool = false, multiLineEndKeyword: String? = nil) -> String {
...
func pushGitTags(force: Bool = false, remote: String? = nil) {
...
func pushToGitRemote(localBranch: String? = nil, remoteBranch: String? = nil, force: Bool = false, tags: Bool = true, remote: String = "origin") {
...
@discardableResult func registerDevice(name: String, udid: String, teamId: String? = nil, teamName: String? = nil, username: String) -> String {
...
func registerDevices(devices: String? = nil, devicesFile: String? = nil, teamId: String? = nil, teamName: String? = nil, username: String) {
...
func resetGitRepo(files: String? = nil, force: Bool = false, skipClean: Bool = false, disregardGitignore: Bool = true, exclude: String? = nil) {
...
func resign(ipa: String, signingIdentity: String, entitlements: String? = nil, provisioningProfile: String, version: String? = nil, displayName: String? = nil, shortVersion: String? = nil, bundleVersion: String? = nil, bundleId: String? = nil, useAppEntitlements: String? = nil, keychainPath: String? = nil) {
...
func scan(workspace: String? = scanfile.workspace, project: String? = scanfile.project, device: String? = scanfile.device, toolchain: String? = scanfile.toolchain, devices: [String] = scanfile.devices, scheme: String? = scanfile.scheme, clean: Bool = scanfile.clean, codeCoverage: String? = scanfile.codeCoverage, addressSanitizer: String? = scanfile.addressSanitizer, threadSanitizer: String? = scanfile.threadSanitizer, skipBuild: Bool = scanfile.skipBuild, outputDirectory: String = scanfile.outputDirectory, outputStyle: String? = scanfile.outputStyle, outputTypes: String = scanfile.outputTypes, outputFiles: String? = scanfile.outputFiles, buildlogPath: String = scanfile.buildlogPath, includeSimulatorLogs: Bool = scanfile.includeSimulatorLogs, formatter: String? = scanfile.formatter, testWithoutBuilding: String? = scanfile.testWithoutBuilding, buildForTesting: String? = scanfile.buildForTesting, xctestrun: String? = scanfile.xctestrun, derivedDataPath: String? = scanfile.derivedDataPath, resultBundle: String? = scanfile.resultBundle, sdk: String? = scanfile.sdk, openReport: Bool = scanfile.openReport, configuration: String? = scanfile.configuration, destination: String? = scanfile.destination, xcargs: String? = scanfile.xcargs, xcconfig: String? = scanfile.xcconfig, onlyTesting: String? = scanfile.onlyTesting, skipTesting: String? = scanfile.skipTesting, slackUrl: String? = scanfile.slackUrl, slackChannel: String? = scanfile.slackChannel, slackMessage: String? = scanfile.slackMessage, skipSlack: Bool = scanfile.skipSlack, slackOnlyOnFailure: Bool = scanfile.slackOnlyOnFailure, useClangReportName: Bool = scanfile.useClangReportName, customReportFileName: String? = scanfile.customReportFileName, failBuild: Bool = scanfile.failBuild) {
...
func scp(username: String, password: String? = nil, host: String, port: String = "22", upload: [String : String]? = nil, download: [String : String]? = nil) {
...
func setBuildNumberRepository(useHgRevisionNumber: Bool = false, xcodeproj: String? = nil) {
...
func setChangelog(appIdentifier: String, username: String, version: String? = nil, changelog: String? = nil, teamId: String? = nil, teamName: String? = nil) {
...
@discardableResult func setGithubRelease(repositoryName: String, serverUrl: String = "https://api.github.com", apiToken: String, tagName: String, name: String? = nil, commitish: String? = nil, description: String? = nil, isDraft: Bool = false, isPrerelease: Bool = false, uploadAssets: String? = nil) -> [String : String] {
...
func setInfoPlistValue(key: String, subkey: String? = nil, value: String, path: String, outputFileName: String? = nil) {
...
func setPodKey(useBundleExec: Bool = true, key: String, value: String, project: String? = nil) {
...
@discardableResult func sh(command: String, log: Bool = true, errorCallback: ((String) -> Void) = {_ in }) -> String {
...
func snapshot(workspace: String? = snapshotfile.workspace, project: String? = snapshotfile.project, xcargs: String? = snapshotfile.xcargs, devices: [String] = snapshotfile.devices, languages: [String] = snapshotfile.languages, launchArguments: [String] = snapshotfile.launchArguments, outputDirectory: String = snapshotfile.outputDirectory, outputSimulatorLogs: Bool = snapshotfile.outputSimulatorLogs, iosVersion: String? = snapshotfile.iosVersion, skipOpenSummary: Bool = snapshotfile.skipOpenSummary, skipHelperVersionCheck: Bool = snapshotfile.skipHelperVersionCheck, clearPreviousScreenshots: Bool = snapshotfile.clearPreviousScreenshots, reinstallApp: Bool = snapshotfile.reinstallApp, eraseSimulator: Bool = snapshotfile.eraseSimulator, localizeSimulator: Bool = snapshotfile.localizeSimulator, appIdentifier: String? = snapshotfile.appIdentifier, addPhotos: [String] = snapshotfile.addPhotos, addVideos: [String] = snapshotfile.addVideos, buildlogPath: String = snapshotfile.buildlogPath, clean: Bool = snapshotfile.clean, configuration: String? = snapshotfile.configuration, xcprettyArgs: String? = snapshotfile.xcprettyArgs, sdk: String? = snapshotfile.sdk, scheme: String? = snapshotfile.scheme, numberOfRetries: Int = snapshotfile.numberOfRetries, stopAfterFirstError: Bool = snapshotfile.stopAfterFirstError, derivedDataPath: String? = snapshotfile.derivedDataPath, testTargetName: String? = snapshotfile.testTargetName, namespaceLogFiles: String? = snapshotfile.namespaceLogFiles, concurrentSimulators: Bool = snapshotfile.concurrentSimulators) {
...
func sonar(projectConfigurationPath: String? = nil, projectKey: String? = nil, projectName: String? = nil, projectVersion: String? = nil, sourcesPath: String? = nil, projectLanguage: String? = nil, sourceEncoding: String? = nil, sonarRunnerArgs: String? = nil, sonarLogin: String? = nil) {
...
func splunkmint(dsym: String? = nil, apiKey: String, apiToken: String, verbose: Bool = false, uploadProgress: Bool = false, proxyUsername: String? = nil, proxyPassword: String? = nil, proxyAddress: String? = nil, proxyPort: String? = nil) {
...
func ssh(username: String, password: String? = nil, host: String, port: String = "22", commands: [String]? = nil, log: Bool = true) {
...
func swiftlint(mode: String = "lint", outputFile: String? = nil, configFile: String? = nil, strict: Bool = false, files: String? = nil, ignoreExitStatus: Bool = false, reporter: String? = nil, quiet: Bool = false, executable: String? = nil) {
...
func testfairy(apiKey: String, ipa: String, symbolsFile: String? = nil, testersGroups: [String] = [], metrics: [String] = [], iconWatermark: String = "off", comment: String = "No comment provided", autoUpdate: String = "off", notify: String = "off", options: [String] = []) {
...
func testflight(username: String, appIdentifier: String? = nil, appPlatform: String = "ios", ipa: String? = nil, changelog: String? = nil, betaAppDescription: String? = nil, betaAppFeedbackEmail: String? = nil, skipSubmission: Bool = false, skipWaitingForBuildProcessing: Bool = false, updateBuildInfoOnUpload: Bool = false, appleId: String? = nil, distributeExternal: Bool = false, firstName: String? = nil, lastName: String? = nil, email: String? = nil, testersFilePath: String = "./testers.csv", waitProcessingInterval: Int = 30, teamId: String? = nil, teamName: String? = nil, devPortalTeamId: String? = nil, itcProvider: String? = nil, groups: [String]? = nil, waitForUploadedBuild: Bool = false) {
  let command = RubyCommand(commandID: "", methodName: "testflight", className: nil, args: [RubyCommand.Argument(name: "username", value: username), RubyCommand.Argument(name: "app_identifier", value: appIdentifier), RubyCommand.Argument(name: "app_platform", value: appPlatform), RubyCommand.Argument(name: "ipa", value: ipa), RubyCommand.Argument(name: "changelog", value: changelog), RubyCommand.Argument(name: "beta_app_description", value: betaAppDescription), RubyCommand.Argument(name: "beta_app_feedback_email", value: betaAppFeedbackEmail), RubyCommand.Argument(name: "skip_submission", value: skipSubmission), RubyCommand.Argument(name: "skip_waiting_for_build_processing", value: skipWaitingForBuildProcessing), RubyCommand.Argument(name: "update_build_info_on_upload", value: updateBuildInfoOnUpload), RubyCommand.Argument(name: "apple_id", value: appleId), RubyCommand.Argument(name: "distribute_external", value: distributeExternal), RubyCommand.Argument(name: "first_name", value: firstName), RubyCommand.Argument(name: "last_name", value: lastName), RubyCommand.Argument(name: "email", value: email), RubyCommand.Argument(name: "testers_file_path", value: testersFilePath), RubyCommand.Argument(name: "wait_processing_interval", value: waitProcessingInterval), RubyCommand.Argument(name: "team_id", value: teamId), RubyCommand.Argument(name: "team_name", value: teamName), RubyCommand.Argument(name: "dev_portal_team_id", value: devPortalTeamId), RubyCommand.Argument(name: "itc_provider", value: itcProvider), RubyCommand.Argument(name: "groups", value: groups), RubyCommand.Argument(name: "wait_for_uploaded_build", value: waitForUploadedBuild)])
  _ = runner.executeCommand(command)
}
func tryouts(appId: String, apiToken: String, buildFile: String, notes: String? = nil, notesPath: String? = nil, notify: String = "1", status: String = "2") {
...
func unlockKeychain(path: String, password: String, addToSearchList: Bool = true, setDefault: Bool = false) {
...
func updateFastlane(nightly: Bool = false, noUpdate: Bool = false, tools: String? = nil) {
...
func updateInfoPlist(xcodeproj: String? = nil, plistPath: String? = nil, scheme: String? = nil, appIdentifier: String? = nil, displayName: String? = nil, block: String? = nil) {
...
func updateProjectProvisioning(xcodeproj: String? = nil, profile: String, targetFilter: String? = nil, buildConfigurationFilter: String? = nil, buildConfiguration: String? = nil, certificate: String = "/tmp/AppleIncRootCertificate.cer") {
...
func updateUrbanAirshipConfiguration(plistPath: String, developmentAppKey: String? = nil, developmentAppSecret: String? = nil, productionAppKey: String? = nil, productionAppSecret: String? = nil, detectProvisioningMode: String? = nil) {
...
func uploadSymbolsToSentry(apiHost: String = "https://app.getsentry.com/api/0", apiKey: String? = nil, authToken: String? = nil, orgSlug: String, projectSlug: String, dsymPath: String? = nil, dsymPaths: String? = nil) {
...
func verifyBuild(provisioningType: String? = nil, provisioningUuid: String? = nil, teamIdentifier: String? = nil, teamName: String? = nil, appName: String? = nil, bundleIdentifier: String? = nil, ipaPath: String? = nil) {
...
func versionBumpPodspec(path: String, bumpType: String = "patch", versionNumber: String? = nil, versionAppendix: String? = nil) {
...
@discardableResult func xcodeInstall(version: String, username: String, teamId: String? = nil) -> String {
...
@discardableResult func xcodeServerGetAssets(host: String, botName: String, integrationNumber: String? = nil, username: String = "", password: String = "", targetFolder: String = "./xcs_assets", keepAllAssets: Bool = false, trustSelfSignedCerts: Bool = true) -> [String] {
...
@discardableResult func zip(path: String, outputPath: String? = nil, verbose: Bool = true) -> String {

func adb(serial: String = "", command: String, adbPath: String = "adb") -> Any {
...
func adbDevices(adbPath: String = "adb") -> Any {
...
func addExtraPlatforms(platforms: String = "") -> Any {
...
func addGitTag(tag: String, grouping: String = "builds", prefix🚀: String = "", buildNumber: String, message: String, commit: String, force: String = "false", sign: String = "false") -> Any {
...
func appStoreBuildNumber(initialBuildNumber: String = "1", appIdentifier: String, username: String, teamId: String, live: String = "true", version: String, teamName: String) -> Any {
...
func appaloosa(binary: String, apiToken: String, storeId: String, groupIds: String = "", screenshots: String, locale: String = "en-US", device: String, description: String) -> Any {
...
func appetize(apiToken: String, url: String, platform: String = "ios", path: String, publicKey: String, note: String) -> Any {
...
func appetizeViewingUrlGenerator(publicKey: String, baseUrl: String = "https://appetize.io/embed", device: String = "iphone5s", scale: String, orientation: String = "portrait", language: String, color: String = "black", launchUrl: String, osVersion: String, params: String, proxy: String) -> Any {
...
func appium(platform: String, specPath: String, appPath: String, invokeAppiumServer: String = "true", host: String = "0.0.0.0", port: String = "4723", appiumPath: String, caps: String) -> Any {
...
func apteligent(dsym: String, appId: String, apiKey: String) -> Any {
...
func artifactory(file: String, repo: String, repoPath: String, endpoint: String, username: String, password: String, properties: String = "{}", sslPemFile: String, sslVerify: String = "true", proxyUsername: String, proxyPassword: String, proxyAddress: String, proxyPort: String) -> Any {
...
func automaticCodeSigning(path: String, useAutomaticSigning: String = "false", teamId: String, targets: String) -> Any {
...
func backupFile(path: String) -> Any {
  let command = RubyCommand(commandID: "", methodName: "backup_file", className: nil, args: [RubyCommand.Argument(name: "path", value: path)])
  return runner.executeCommand(command)
}
func backupXcarchive(xcarchive: String, destination: String, zip: String = "true", versioned: String = "true") -> Any {
...
func badge(dark: String, custom: String, noBadge: String, shield: String, alpha: String, path: String = ".", shieldIoTimeout: String, glob: String, alphaChannel: String, shieldGravity: String, shieldNoResize: String) -> Any {
...
func buildAndUploadToAppetize(xcodebuild: String = "{}", scheme: String, apiToken: String) -> Any {
...
func bundleInstall(binstubs: String, clean: String = "false", fullIndex: String = "false", gemfile: String, jobs: String, local: String = "false", deployment: String = "false", noCache: String = "false", noPrune: String = "false", path: String, system: String = "false", quiet: String = "false", retry: String, shebang: String, standalone: String, trustPolicy: String, without: String, with: String) -> Any {
...
func cert(development: String = "false", force: String = "false", username: String, teamId: String, teamName: String, outputPath: String = ".", keychainPath: String = "/Users/jliebowitz/Library/Keychains/login.keychain-db", keychainPassword: String, platform: String = "ios") -> Any {
...
func changelogFromGitCommits(between: String, commitsCount: String, pretty: String = "%B", dateFormat: String, ancestryPath: String = "false", tagMatchPattern: String, matchLightweightTag: String = "true", includeMerges: String, mergeCommitFiltering: String = "include_merges") -> Any {
...
func chatwork(apiToken: String, message: String, roomid: String, success: String = "true") -> Any {
...
func cleanBuildArtifacts(excludePattern: String) -> Any {
...
func cleanCocoapodsCache(name: String) -> Any {
...
func clearDerivedData(derivedDataPath: String = "~/Library/Developer/Xcode/DerivedData") -> Any {
...
func clipboard(value: String) -> Any {
  let command = RubyCommand(commandID: "", methodName: "clipboard", className: nil, args: [RubyCommand.Argument(name: "value", value: value)])
  return runner.executeCommand(command)
}
func cloc(binaryPath: String = "/usr/local/bin/cloc", excludeDir: String, outputDirectory: String = "build", sourceDirectory: String = "", xml: String = "true") -> Any {
...
func cocoapods(clean: String = "true", integrate: String = "true", repoUpdate: String = "false", silent: String = "false", verbose: String = "false", ansi: String = "true", useBundleExec: String = "true", podfile: String, errorCallback: String) -> Any {
...
func commitGithubFile(repositoryName: String, serverUrl: String = "https://api.github.com", apiToken: String, branch: String = "master", path: String, message: String, secure: String = "true") -> Any {
...
func commitVersionBump(message: String, xcodeproj: String, force: String = "false", settings: String = "false", ignore: String) -> Any {
...
func copyArtifacts(keepOriginal: String = "true", targetPath: String = "artifacts", artifacts: [String] = [], failOnMissing: String = "false") -> Any {
...
func crashlytics(ipaPath: String, apkPath: String, crashlyticsPath: String, apiToken: String, buildSecret: String, notesPath: String, notes: String, groups: String, emails: String, notifications: String = "true", debug: String = "false") -> Any {
...
func createKeychain(name: String, path: String, password: String, defaultKeychain: String = "false", unlock: String = "false", timeout: String = "300", lockWhenSleeps: String = "false", lockAfterTimeout: String = "false", addToSearchList: String = "true") -> Any {
...
func createPullRequest(apiToken: String, repo: String, title: String, body: String, head: String = "swift-gen", base: String = "master", apiUrl: String = "https://api.github.com") -> Any {
...
func danger(useBundleExec: String = "true", verbose: String = "false", dangerId: String, dangerfile: String, githubApiToken: String, failOnErrors: String = "false", newComment: String = "false", base: String, head: String) -> Any {
...
func deleteKeychain(name: String, keychainPath: String) -> Any {
...
func deploygate(apiToken: String, user: String, ipa: String, apk: String, message: String = "No changelog provided", distributionKey: String, releaseNote: String, disableNotify: String = "false") -> Any {
...
func dotgpgEnvironment(dotgpgFile: String) -> Any {
...
func download(url: String) -> Any {
  let command = RubyCommand(commandID: "", methodName: "download", className: nil, args: [RubyCommand.Argument(name: "url", value: url)])
  return runner.executeCommand(command)
}
func downloadDsyms(username: String, appIdentifier: String, teamId: String, teamName: String, platform: String, version: String, buildNumber: String) -> Any {
...
func dsymZip(archivePath: String, dsymPath: String, all: String = "false") -> Any {
...
func ensureGitBranch(branch: String = "master") -> Any {
...
func ensureGitStatusClean(showUncommittedChanges: String = "false") -> Any {
...
func ensureNoDebugCode(text: String, path: String = ".", extension🚀: String, extensions: String, exclude: String, excludeDirs: String) -> Any {
...
func ensureXcodeVersion(version: String) -> Any {
...
func erb(template: String, destination: String, placeholders: String = "{}") -> Any {
...
func flock(message: String, token: String, baseUrl: String = "https://api.flock.co/hooks/sendMessage") -> Any {
...
func frameit(white: String, silver: String, roseGold: String, gold: String, forceDeviceType: String, useLegacyIphone5s: String = "false", useLegacyIphone6s: String = "false", path: String = "./") -> Any {
...
func getBuildNumber(xcodeproj: String) -> Any {
...
func getBuildNumberRepository(useHgRevisionNumber: String = "false") -> Any {
...
func getGithubRelease(url: String, serverUrl: String = "https://api.github.com", version: String, apiToken: String) -> Any {
...
func getInfoPlistValue(key: String, path: String) -> Any {
...
func getIpaInfoPlistValue(key: String, ipa: String) -> Any {
...
func getVersionNumber(xcodeproj: String, scheme: String, target: String) -> Any {
...
func gitAdd(path: String, pathspec: String) -> Any {
...
func gitCommit(path: String, message: String) -> Any {
...
func gitPull(onlyTags: String = "false") -> Any {
...
func gitTagExists(tag: String) -> Any {
  let command = RubyCommand(commandID: "", methodName: "git_tag_exists", className: nil, args: [RubyCommand.Argument(name: "tag", value: tag)])
  return runner.executeCommand(command)
}
func githubApi(serverUrl: String = "https://api.github.com", apiToken: String, httpMethod: String = "GET", body: String = "{}", rawBody: String, path: String, url: String, errorHandlers: String = "{}", headers: String = "{}", secure: String = "true") -> Any {
...
func googlePlayTrackVersionCodes(packageName: String, track: String = "production", key: String, issuer: String, jsonKey: String, jsonKeyData: String, rootUrl: String) -> Any {
...
func gradle(task: String, flavor: String, buildType: String, flags: String, projectDir: String = ".", gradlePath: String, properties: String, serial: String = "", printCommand: String = "true", printCommandOutput: String = "true") -> Any {
...
func hgAddTag(tag: String) -> Any {
  let command = RubyCommand(commandID: "", methodName: "hg_add_tag", className: nil, args: [RubyCommand.Argument(name: "tag", value: tag)])
  return runner.executeCommand(command)
}
func hgCommitVersionBump(message: String = "Version Bump", xcodeproj: String, force: String = "false", testDirtyFiles: String = "file1, file2", testExpectedFiles: String = "file1, file2") -> Any {
...
func hgPush(force: String = "false", destination: String = "") -> Any {
...
func hipchat(message: String = "", channel: String, apiToken: String, customColor: String, success: String = "true", version: String, notifyRoom: String = "false", apiHost: String = "api.hipchat.com", messageFormat: String = "html", includeHtmlHeader: String = "true", from: String = "fastlane") -> Any {
...
func ifttt(apiKey: String, eventName: String, value1: String, value2: String, value3: String) -> Any {
...
func importCertificate(keychainName: String, keychainPath: String, keychainPassword: String, certificatePath: String, certificatePassword: String = "", logOutput: String = "false") -> Any {
...
func importFromGit(url: String, branch: String = "HEAD", path: String = "fastlane/Fastfile") -> Any {
...
func incrementBuildNumber(buildNumber: String, xcodeproj: String) -> Any {
...
func incrementVersionNumber(bumpType: String = "patch", versionNumber: String, xcodeproj: String) -> Any {
...
func installOnDevice(extra: String, deviceId: String, skipWifi: String, ipa: String) -> Any {
...
func installXcodePlugin(url: String, github: String) -> Any {
...
func installr(apiToken: String, ipa: String, notes: String, notify: String, add: String) -> Any {
...
func ipa(workspace: String, project: String, configuration: String, scheme: String, clean: String, archive: String, destination: String, embed: String, identity: String, sdk: String, ipa: String, xcconfig: String, xcargs: String) -> Any {
...
func jazzy(config: String) -> Any {
  let command = RubyCommand(commandID: "", methodName: "jazzy", className: nil, args: [RubyCommand.Argument(name: "config", value: config)])
  return runner.executeCommand(command)
}
func jira(url: String, username: String, password: String, ticketId: String, commentText: String) -> Any {
...
func latestTestflightBuildNumber(live: String = "false", appIdentifier: String, username: String, version: String, initialBuildNumber: String = "1", teamId: String, teamName: String) -> Any {
...
func lcov(projectName: String, scheme: String, arch: String = "i386", outputDir: String = "coverage_reports") -> Any {
...
func makeChangelogFromJenkins(fallbackChangelog: String = "", includeCommitBody: String = "true") -> Any {
...
func modifyServices(username: String, appIdentifier: String, services: String = "{}", teamId: String, teamName: String) -> Any {
...
func nexusUpload(file: String, repoId: String, repoGroupId: String, repoProjectName: String, repoProjectVersion: String, repoClassifier: String, endpoint: String, mountPath: String = "/nexus", username: String, password: String, sslVerify: String = "true", verbose: String = "false", proxyUsername: String, proxyPassword: String, proxyAddress: String, proxyPort: String) -> Any {
...
func notification(title: String = "fastlane", subtitle: String, message: String, sound: String, activate: String, appIcon: String, contentImage: String, open: String, execute: String) -> Any {
...
func numberOfCommits(all: String) -> Any {
...
func oclint(oclintPath: String = "oclint", compileCommands: String = "compile_commands.json", selectReqex: String, selectRegex: String, excludeRegex: String, reportType: String = "html", reportPath: String, listEnabledRules: String = "false", rc: String, thresholds: String, enableRules: String, disableRules: String, maxPriority1: String, maxPriority2: String, maxPriority3: String, enableClangStaticAnalyzer: String = "false", enableGlobalAnalysis: String = "false", allowDuplicatedViolations: String = "false") -> Any {
...
func onesignal(authToken: String, appName: String, androidToken: String, apnsP12: String, apnsP12Password: String, apnsEnv: String = "production") -> Any {
...
func pem(development: String = "false", generateP12: String = "true", activeDaysLimit: String = "30", force: String = "false", savePrivateKey: String = "true", appIdentifier: String, username: String, teamId: String, teamName: String, p12Password: String = "", pemName: String, outputPath: String = ".", newProfile: String) -> Any {
...
func pilot(username: String, appIdentifier: String, appPlatform: String, ipa: String, changelog: String, betaAppDescription: String, betaAppFeedbackEmail: String, skipSubmission: String = "false", skipWaitingForBuildProcessing: String = "false", updateBuildInfoOnUpload: String = "false", appleId: String, distributeExternal: String = "false", firstName: String, lastName: String, email: String, testersFilePath: String = "./testers.csv", waitProcessingInterval: String = "30", teamId: String, teamName: String, devPortalTeamId: String, itcProvider: String, groups: String) -> Any {
...
func pluginScores(outputPath: String, templatePath: String) -> Any {
...
func podLibLint(useBundleExec: String = "true", verbose: String, allowWarnings: String, sources: String, useLibraries: String = "false", failFast: String = "false", private🚀: String = "false", quick: String = "false") -> Any {
...
func podPush(path: String, repo: String, allowWarnings: String, useLibraries: String, sources: String, verbose: String = "false") -> Any {
...
func podioItem(clientId: String, clientSecret: String, appId: String, appToken: String, identifyingField: String, identifyingValue: String, otherFields: String) -> Any {
...
func precheck(appIdentifier: String, username: String, teamId: String, teamName: String, defaultRuleLevel: String = "error", negativeAppleSentiment: String, placeholderText: String, otherPlatforms: String, futureFunctionality: String, testWords: String, curseWords: String, customText: String, copyrightDate: String, unreachableUrls: String) -> Any {
...
func produce(username: String, appIdentifier: String, bundleIdentifierSuffix: String, appName: String, appVersion: String, sku: String = "1503851419", platform: String = "ios", language: String = "English", companyName: String, skipItc: String = "false", itcUsers: String, enabledFeatures: String = "{}", enableServices: String = "{}", skipDevcenter: String = "false", teamId: String, teamName: String, itcTeamId: String, itcTeamName: String) -> Any {
...
func prompt(text: String = "Please enter a text: ", ciInput: String = "", boolean: String = "false", multiLineEndKeyword: String) -> Any {
...
func pushGitTags(force: String = "false", remote: String) -> Any {
...
func pushToGitRemote(localBranch: String, remoteBranch: String, force: String = "false", tags: String = "true", remote: String = "origin") -> Any {
...
func registerDevice(name: String, udid: String, teamId: String, teamName: String, username: String) -> Any {
...
func registerDevices(devices: String, devicesFile: String, teamId: String, teamName: String, username: String) -> Any {
...
func resetGitRepo(files: String, force: String = "false", skipClean: String = "false", disregardGitignore: String = "true", exclude: String) -> Any {
...
func resetSimulatorContents(ios: String) -> Any {
...
func resign(ipa: String, signingIdentity: String, entitlements: String, provisioningProfile: String, version: String, displayName: String, shortVersion: String, bundleVersion: String, bundleId: String, useAppEntitlements: String, keychainPath: String) -> Any {
...
func restoreFile(path: String) -> Any {
...
func rsync(extra: String = "-av", source: String, destination: String) -> Any {
...
func scp(username: String, password: String, host: String, port: String = "22", upload: String, download: String) -> Any {
...
func setBuildNumberRepository(useHgRevisionNumber: String = "false", xcodeproj: String) -> Any {
...
func setChangelog(appIdentifier: String, username: String, version: String, changelog: String, teamId: String, teamName: String) -> Any {
...
func setGithubRelease(repositoryName: String, serverUrl: String = "https://api.github.com", apiToken: String, tagName: String, name: String, commitish: String, description: String, isDraft: String = "false", isPrerelease: String = "false", uploadAssets: String) -> Any {
...
func setInfoPlistValue(key: String, subkey: String, value: String, path: String, outputFileName: String) -> Any {
...
func setPodKey(useBundleExec: String = "true", key: String, value: String, project: String) -> Any {
...
func setupJenkins(force: String = "false", unlockKeychain: String = "true", addKeychainToSearchList: String = "replace", setDefaultKeychain: String = "true", keychainPath: String, keychainPassword: String = "", setCodeSigningIdentity: String = "true", codeSigningIdentity: String, outputDirectory: String = "./output", derivedDataPath: String = "./derivedData", resultBundle: String = "true") -> Any {
...
func slack(message: String, channel: String, useWebhookConfiguredUsernameAndIcon: String = "false", slackUrl: String, username: String = "fastlane", iconUrl: String = "https://s3-eu-west-1.amazonaws.com/fastlane.tools/fastlane.png", payload: String = "{}", defaultPayloads: String, attachmentProperties: String = "{}", success: String = "true") -> Any {
...
func sonar(projectConfigurationPath: String, projectKey: String, projectName: String, projectVersion: String, sourcesPath: String, projectLanguage: String, sourceEncoding: String, sonarRunnerArgs: String, sonarLogin: String) -> Any {
...
func splunkmint(dsym: String, apiKey: String, apiToken: String, verbose: String = "false", uploadProgress: String = "false", proxyUsername: String, proxyPassword: String, proxyAddress: String, proxyPort: String) -> Any {
...
func ssh(username: String, password: String, host: String, port: String = "22", commands: String, log: String = "true") -> Any {
...
func swiftlint(mode: String = "lint", outputFile: String, configFile: String, strict: String = "false", files: String, ignoreExitStatus: String = "false", reporter: String, quiet: String = "false", executable: String) -> Any {
...
func testfairy(apiKey: String, ipa: String, symbolsFile: String, testersGroups: [String] = [], metrics: [String] = [], iconWatermark: String = "off", comment: String = "No comment provided", autoUpdate: String = "off", notify: String = "off", options: [String] = []) -> Any {
...
func tryouts(appId: String, apiToken: String, buildFile: String, notes: String, notesPath: String, notify: String = "1", status: String = "2") -> Any {
...
func twitter(consumerKey: String, consumerSecret: String, accessToken: String, accessTokenSecret: String, message: String) -> Any {
...
func unlockKeychain(path: String, password: String, addToSearchList: String = "true", setDefault: String = "false") -> Any {
...
func updateAppGroupIdentifiers(entitlementsFile: String, appGroupIdentifiers: String) -> Any {
...
func updateAppIdentifier(xcodeproj: String, plistPath: String, appIdentifier: String) -> Any {
...
func updateFastlane(nightly: String = "false", noUpdate: String = "false", tools: String) -> Any {
...
func updateIcloudContainerIdentifiers(entitlementsFile: String, icloudContainerIdentifiers: String) -> Any {
...
func updateInfoPlist(xcodeproj: String, plistPath: String, scheme: String, appIdentifier: String, displayName: String, block: String) -> Any {
...
func updateProjectCodeSigning(path: String, udid: String, uuid: String) -> Any {
...
func updateProjectProvisioning(xcodeproj: String, profile: String, targetFilter: String, buildConfigurationFilter: String, buildConfiguration: String, certificate: String = "/tmp/AppleIncRootCertificate.cer") -> Any {
...
func updateProjectTeam(path: String, teamid: String) -> Any {
...
func updateUrbanAirshipConfiguration(plistPath: String, developmentAppKey: String, developmentAppSecret: String, productionAppKey: String, productionAppSecret: String, detectProvisioningMode: String) -> Any {
...
func updateUrlSchemes(path: String, urlSchemes: String) -> Any {
...
func uploadSymbolsToCrashlytics(dsymPath: String = "./spec/fixtures/dSYM/Themoji.dSYM", apiToken: String, binaryPath: String, platform: String = "ios") -> Any {
...
func uploadSymbolsToSentry(apiHost: String = "https://app.getsentry.com/api/0", apiKey: String, authToken: String, orgSlug: String, projectSlug: String, dsymPath: String, dsymPaths: String) -> Any {
...
func verifyBuild(provisioningType: String, provisioningUuid: String, teamIdentifier: String, teamName: String, appName: String, bundleIdentifier: String, ipaPath: String) -> Any {
...
func verifyXcode(xcodePath: String = "/Applications/Xcode.app") -> Any {
...
func versionBumpPodspec(path: String, bumpType: String = "patch", versionNumber: String, versionAppendix: String) -> Any {
...
func versionGetPodspec(path: String) -> Any {
...
func xcodeInstall(version: String, username: String, teamId: String) -> Any {
...
func xcodeServerGetAssets(host: String, botName: String, integrationNumber: String, username: String = "", password: String = "", targetFolder: String = "./xcs_assets", keepAllAssets: String = "false", trustSelfSignedCerts: String = "true") -> Any {
...
func xcversion(version: String) -> Any {
...
func zip(path: String, outputPath: String, verbose: String = "true") -> Any {

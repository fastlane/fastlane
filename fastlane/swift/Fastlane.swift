func adb(serial: String = "", command: String? = nil, adbPath: String = "adb") -> String {
...
func backupXcarchive(xcarchive: String, destination: String, zip: Bool = true, versioned: Bool = true) {
...
func buildAndUploadToAppetize(xcodebuild: String = "{}", scheme: String? = nil, apiToken: String) {
...
func cert(development: Bool = false, force: Bool = false, username: String, teamId: String? = nil, teamName: String? = nil, outputPath: String = ".", keychainPath: String = "/Users/jliebowitz/Library/Keychains/login.keychain-db", keychainPassword: String? = nil, platform: String = "ios") {
...
func changelogFromGitCommits(between: String? = nil, commitsCount: String? = nil, pretty: String = "%B", dateFormat: String? = nil, ancestryPath: Bool = false, tagMatchPattern: String? = nil, matchLightweightTag: Bool = true, includeMerges: String? = nil, mergeCommitFiltering: String = "include_merges") -> String {
...
func cocoapods(clean: Bool = true, integrate: Bool = true, repoUpdate: Bool = false, silent: Bool = false, verbose: Bool = false, ansi: Bool = true, useBundleExec: Bool = true, podfile: String? = nil, errorCallback: String? = nil) {
...
func createPullRequest(apiToken: String, repo: String, title: String, body: String? = nil, head: String = "swift-gen", base: String = "master", apiUrl: String = "https://api.github.com") {
...
func deliver(username: String, appIdentifier: String? = nil, app: String, editLive: Bool = false, ipa: String? = nil, pkg: String? = nil, platform: String = "ios", metadataPath: String? = nil, screenshotsPath: String? = nil, skipBinaryUpload: Bool = false, skipScreenshots: Bool = false, appVersion: String? = nil, skipMetadata: Bool = false, skipAppVersionUpdate: Bool = false, force: Bool = false, submitForReview: Bool = false, automaticRelease: Bool = false, phasedRelease: String? = nil, priceTier: String? = nil, buildNumber: String? = nil, appRatingConfigPath: String? = nil, submissionInformation: String? = nil, teamId: String? = nil, teamName: String? = nil, devPortalTeamId: String? = nil, devPortalTeamName: String? = nil, itcProvider: String? = nil, overwriteScreenshots: Bool = false, runPrecheckBeforeSubmit: Bool = true, precheckDefaultRuleLevel: String = "warn", appIcon: String? = nil, appleWatchAppIcon: String? = nil, copyright: String? = nil, primaryCategory: String? = nil, secondaryCategory: String? = nil, primaryFirstSubCategory: String? = nil, primarySecondSubCategory: String? = nil, secondaryFirstSubCategory: String? = nil, secondarySecondSubCategory: String? = nil, tradeRepresentativeContactInformation: String? = nil, appReviewInformation: String? = nil, description: String? = nil, name: String? = nil, subtitle: String? = nil, keywords: String? = nil, promotionalText: String? = nil, releaseNotes: String? = nil, privacyUrl: String? = nil, supportUrl: String? = nil, marketingUrl: String? = nil, languages: String? = nil, ignoreLanguageDirectoryValidation: Bool = false) {
...
func erb(template: String, destination: String? = nil, placeholders: String = "{}") {
...
func incrementBuildNumber(buildNumber: String? = nil, xcodeproj: String? = nil) -> String {
...
func incrementVersionNumber(bumpType: String = "patch", versionNumber: String? = nil, xcodeproj: String? = nil) -> String {
...
func latestTestflightBuildNumber(live: Bool = false, appIdentifier: String, username: String, version: String? = nil, initialBuildNumber: String = "1", teamId: String? = nil, teamName: String? = nil) -> Int {
...
func numberOfCommits(all: String? = nil) -> Int {
...
func precheck(appIdentifier: String, username: String, teamId: String? = nil, teamName: String? = nil, defaultRuleLevel: String = "error", negativeAppleSentiment: String? = nil, placeholderText: String? = nil, otherPlatforms: String? = nil, futureFunctionality: String? = nil, testWords: String? = nil, curseWords: String? = nil, customText: String? = nil, copyrightDate: String? = nil, unreachableUrls: String? = nil) -> Bool {
...
func registerDevice(name: String, udid: String, teamId: String? = nil, teamName: String? = nil, username: String) -> String {
...
func scan(workspace: String? = nil, project: String? = nil, device: String? = nil, toolchain: String? = nil, devices: String? = nil, scheme: String? = nil, clean: Bool = false, codeCoverage: String? = nil, addressSanitizer: String? = nil, threadSanitizer: String? = nil, skipBuild: Bool = false, outputDirectory: String = "./test_output", outputStyle: String? = nil, outputTypes: String = "html,junit", outputFiles: String? = nil, buildlogPath: String = "~/Library/Logs/scan", includeSimulatorLogs: Bool = false, formatter: String? = nil, testWithoutBuilding: String? = nil, buildForTesting: String? = nil, xctestrun: String? = nil, derivedDataPath: String? = nil, resultBundle: String? = nil, sdk: String? = nil, openReport: Bool = false, configuration: String? = nil, destination: String? = nil, xcargs: String? = nil, xcconfig: String? = nil, onlyTesting: String? = nil, skipTesting: String? = nil, slackUrl: String? = nil, slackChannel: String? = nil, slackMessage: String? = nil, skipSlack: Bool = false, slackOnlyOnFailure: Bool = false, useClangReportName: Bool = false, customReportFileName: String? = nil, failBuild: Bool = true) {
...
func scp(username: String, password: String? = nil, host: String, port: String = "22", upload: String? = nil, download: String? = nil) {
...
func setGithubRelease(repositoryName: String, serverUrl: String = "https://api.github.com", apiToken: String, tagName: String, name: String? = nil, commitish: String? = nil, description: String? = nil, isDraft: Bool = false, isPrerelease: Bool = false, uploadAssets: String? = nil) -> [String : String] {
...
func uploadSymbolsToCrashlytics(dsymPath: String = "./spec/fixtures/dSYM/Themoji.dSYM", apiToken: String? = nil, binaryPath: String? = nil, platform: String = "ios") {
...
func xcodeInstall(version: String, username: String, teamId: String? = nil) -> String {
...
func xcodeServerGetAssets(host: String, botName: String, integrationNumber: String? = nil, username: String = "", password: String = "", targetFolder: String = "./xcs_assets", keepAllAssets: Bool = false, trustSelfSignedCerts: Bool = true) -> [String] {
...
func zip(path: String, outputPath: String? = nil, verbose: Bool = true) -> String {

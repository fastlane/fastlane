...
func appStoreBuildNumber(initialBuildNumber: String = "1", appIdentifier: String, username: String, teamId: String? = nil, live: Bool = true, version: String? = nil, teamName: String? = nil) {
...
func downloadDsyms(username: String, appIdentifier: String, teamId: String? = nil, teamName: String? = nil, platform: String? = nil, version: String? = nil, buildNumber: String? = nil, outputDirectory: String? = nil) {
...
func gradle(task: String, flavor: String? = nil, buildType: String? = nil, flags: String? = nil, projectDir: String = ".", gradlePath: String? = nil, properties: String? = nil, serial: String = "", printCommand: Bool = true, printCommandOutput: Bool = true) {
...
@discardableResult func latestTestflightBuildNumber(live: Bool = false, appIdentifier: String, username: String, version: String? = nil, initialBuildNumber: String = "1", teamId: String? = nil, teamName: String? = nil) -> Int {
...
func testflight(username: String, appIdentifier: String? = nil, appPlatform: String? = nil, ipa: String? = nil, changelog: String? = nil, betaAppDescription: String? = nil, betaAppFeedbackEmail: String? = nil, skipSubmission: Bool = false, skipWaitingForBuildProcessing: Bool = false, updateBuildInfoOnUpload: Bool = false, appleId: String? = nil, distributeExternal: Bool = false, firstName: String? = nil, lastName: String? = nil, email: String? = nil, testersFilePath: String = "./testers.csv", waitProcessingInterval: Int = 30, teamId: String? = nil, teamName: String? = nil, devPortalTeamId: String? = nil, itcProvider: String? = nil, groups: [String]? = nil) {

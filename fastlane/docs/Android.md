...
- Use 'Fastlane' as name and give 'owner' rights
- Click **Create**, you should see a new entry in the list of service accounts
- Click the overflow menu on the right and select **create key**

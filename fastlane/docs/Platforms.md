...
`fastlane` can handle multiple app platforms in one `Fastfile`. This is super useful for projects supporting multiple platform like iOS, macOS or Android apps.

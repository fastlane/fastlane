...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "spaceship", ">= 0.36.1", "< 1.0.0" # communication layer with Apple's web services

  # All the fastlane tools
  spec.add_dependency "deliver", ">= 1.14.3", "< 2.0.0"
  spec.add_dependency "snapshot", ">= 1.16.2", "< 2.0.0"
  spec.add_dependency "frameit", ">= 2.8.0", "< 4.0.0"
  ...
  spec.add_dependency "pilot", ">= 1.11.0", "< 2.0.0"

...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'spaceship', '>= 0.22.0', '< 1.0.0' # communication layer with Apple's web services

  # All the fastlane tools
  spec.add_dependency 'deliver', '>= 1.10.3', '< 2.0.0'
  spec.add_dependency 'snapshot', '>= 1.11.0', '< 2.0.0'
  spec.add_dependency 'frameit', '>= 2.5.1', '< 3.0.0'
  spec.add_dependency 'pem', '>= 1.3.0', '< 2.0.0'
  spec.add_dependency 'cert', '>= 1.4.0', '< 2.0.0'
  spec.add_dependency 'sigh', '>= 1.4.0', '< 2.0.0'
  spec.add_dependency 'produce', '>= 1.1.1', '< 2.0.0'
  spec.add_dependency 'gym', '>= 1.6.1', '< 2.0.0'
  ...
  spec.add_dependency 'screengrab', '>= 0.3.0', '< 1.0.0'

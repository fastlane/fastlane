...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'krausefx-shenzhen', '>= 0.14.8' # to upload to Hockey and Crashlytics and build the app
  ...
  spec.add_dependency 'fastlane_core', '>= 0.46.3', '< 1.0.0' # all shared code and dependencies
  ...
  spec.add_dependency 'snapshot', '>= 1.12.3', '< 2.0.0'

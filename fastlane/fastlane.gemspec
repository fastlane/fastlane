...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "spaceship", ">= 0.38.4", "< 1.0.0" # communication layer with Apple's web services
  ...
  spec.add_dependency "sigh", ">= 1.12.0", "< 2.0.0"
  spec.add_dependency "produce", ">= 1.3.1", "< 2.0.0"

...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'spaceship', '>= 0.23.0', '< 1.0.0' # communication layer with Apple's web services

  # All the fastlane tools
  spec.add_dependency 'deliver', '>= 1.10.5', '< 2.0.0'
  spec.add_dependency 'snapshot', '>= 1.11.1', '< 2.0.0'

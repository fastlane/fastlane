...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'fastlane_core', '>= 0.46.1', '< 1.0.0' # all shared code and dependencies
  ...
  spec.add_dependency 'deliver', '>= 1.12.0', '< 2.0.0'
  ...
  spec.add_dependency 'pilot', '>= 1.8.0', '< 2.0.0'

...
module Screengrab
  class Options
    DEVICE_TYPES = %w[phone sevenInch tenInch tv wear].freeze
      ...
      @options ||=
        [
          ...
          FastlaneCore::ConfigItem.new(
            ...
            short_option: '-q',
            type: Array,
            default_value: %w[en-US]
          ),
          FastlaneCore::ConfigItem.new(
            key: :clear_previous_screenshots,
          ...
          FastlaneCore::ConfigItem.new(
            key: :test_instrumentation_runner,
          ...
          FastlaneCore::ConfigItem.new(
            ...
            code_gen_sensitive: true,
            default_value:
              Dir[File.join('app', 'build', 'outputs', 'apk', 'app-debug.apk')]
                .last,
            default_value_dynamic: true,
            verify_block:
              proc do |value|
          ...
          FastlaneCore::ConfigItem.new(
            ...
            verify_block:
              proc do |value|
                unless DEVICE_TYPES.include?(value)
                  UI.user_error!("device_type must be one of: #{DEVICE_TYPES}")
                end
              end
          ),
          FastlaneCore::ConfigItem.new(
            key: :exit_on_test_failure,

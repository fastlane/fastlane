...
module Screengrab
  class CommandsGenerator
    ...
    def run
      ...
      program :description,
              "CLI for 'screengrab' - Automate taking localized screenshots of your Android app on emulators or real devices"
      program :help,
              'Authors',
              'Andrea Falcone <asfalcone@google.com>, Michael Furtak <mfurtak@google.com>'
        ...
        c.action do |args, options|
          ...
          Screengrab.android_environment =
            Screengrab::AndroidEnvironment.new(
              Screengrab.config[:android_home],
      ...
      command :init do |c|
        ...
        c.action do |args, options|
          ...
          path =
            if Screengrab::Helper.fastlane_enabled?

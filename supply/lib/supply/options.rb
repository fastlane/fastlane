    ...
    def self.available_options
      @options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :skip_upload_apk,
                                     ...
                                     type: Boolean,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :upload_apk_internal_app_sharing,
                                     env_name: "SUPPLY_UPLOAD_APK_INTERNAL_APP_SHARING",
                                     optional: true,
                                     description: "Whether to uploading APK to internal app sharing",
                                     type: Boolean,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :skip_upload_aab,
                                     ...
                                     type: Boolean,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :upload_aab_internal_app_sharing,
                                     env_name: "SUPPLY_UPLOAD_AAB_INTERNAL_APP_SHARING",
                                     optional: true,
                                     description: "Whether to uploading AAB to internal app sharing",
                                     type: Boolean,
                                     default_value: false),

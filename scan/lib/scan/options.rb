    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :derived_data_path,
                                     ...
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :should_zip_derived_data,
                                     short_option: "-Z",
                                     env_name: "SCAN_SHOULD_ZIP_DERIVED_DATA",
                                     description: "Should zip the derived data and place in output path?",
                                     optional: true,
                                     is_string: false,
                                     default_value: false),

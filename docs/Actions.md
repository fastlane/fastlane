...
- [Actions](#actions)
  - [Building](#building)
    - [[Bundler](http://bundler.io/)](#bundlerhttpbundlerio)
    - [[CocoaPods](http://cocoapods.org)](#cocoapodshttpcocoapodsorg)
    - [[Carthage](https://github.com/Carthage/Carthage)](#carthagehttpsgithubcomcarthagecarthage)
    - [[gym](https://github.com/fastlane/gym)](#gymhttpsgithubcomfastlanegym)
    - [verify_xcode](#verify_xcode)
    - [[snapshot](https://github.com/KrauseFx/snapshot)](#snapshothttpsgithubcomkrausefxsnapshot)
    - [clear_derived_data](#clear_derived_data)
    - [ipa](#ipa)
    - [update_project_provisioning](#update_project_provisioning)
    - [update_app_group_identifiers](#update_app_group_identifiers)
    - [[xcode_install](https://github.com/neonichu/xcode-install)](#xcode_installhttpsgithubcomneonichuxcode-install)
    - [[xcode_select](https://developer.apple.com/library/mac/documentation/Darwin/Reference/ManPages/man1/xcode-select.1.html)](#xcode_selecthttpsdeveloperapplecomlibrarymacdocumentationdarwinreferencemanpagesman1xcode-select1html)
    - [[Xcake](https://github.com/jcampbell05/xcake/)](#xcakehttpsgithubcomjcampbell05xcake)
    - [[resign](https://github.com/krausefx/sigh#resign)](#resignhttpsgithubcomkrausefxsigh#resign)
    ...
    - [[xcodebuild](https://developer.apple.com/library/mac/documentation/Darwin/Reference/ManPages/man1/xcodebuild.1.html)](#xcodebuildhttpsdeveloperapplecomlibrarymacdocumentationdarwinreferencemanpagesman1xcodebuild1html)
    - [copy_artifacts](#copy_artifacts)
    - [clean_build_artifacts](#clean_build_artifacts)
    - [[frameit](https://github.com/KrauseFx/frameit)](#frameithttpsgithubcomkrausefxframeit)
    - [dsym_zip](#dsym_zip)
    - [splunkmint](#splunkmint)
    - [recreate_schemes](#recreate_schemes)
  - [Testing](#testing)
    - [[scan](https://github.com/KrauseFx/scan)](#scanhttpsgithubcomkrausefxscan)
    - [xctest](#xctest)
    - [[xctool](https://github.com/facebook/xctool)](#xctoolhttpsgithubcomfacebookxctool)
    - [[slather](https://github.com/venmo/slather)](#slatherhttpsgithubcomvenmoslather)
    - [[gcovr](http://gcovr.com/)](#gcovrhttpgcovrcom)
    - [[lcov](http://ltp.sourceforge.net/coverage/lcov.php)](#lcovhttpltpsourceforgenetcoveragelcovphp)
    - [[OCLint](http://oclint.org)](#oclinthttpoclintorg)
    - [[SwiftLint](https://github.com/realm/SwiftLint)](#swiftlinthttpsgithubcomrealmswiftlint)
    - [`ensure_no_debug_code`](#ensure_no_debug_code)
    - [[Appium](http://appium.io/)](#appiumhttpappiumio)
  - [Deploying](#deploying)
    - [[pilot](https://github.com/fastlane/pilot)](#pilothttpsgithubcomfastlanepilot)
    - [[deliver](https://github.com/KrauseFx/deliver)](#deliverhttpsgithubcomkrausefxdeliver)
    - [TestFlight](#testflight)
    - [[HockeyApp](http://hockeyapp.net)](#hockeyapphttphockeyappnet)
    - [[Crashlytics Beta](http://try.crashlytics.com/beta/)](#crashlytics-betahttptrycrashlyticscombeta)
    - [AWS S3 Distribution](#aws-s3-distribution)
    - [[DeployGate](https://deploygate.com/)](#deploygatehttpsdeploygatecom)
    - [[Xcode Server](https://www.apple.com/uk/support/osxserver/xcodeserver/)](#xcode-serverhttpswwwapplecomuksupportosxserverxcodeserver)
    - [set_changelog](#set_changelog)
    - [[GitHub Releases](https://github.com)](#github-releaseshttpsgithubcom)
    - [[artifactory](http://www.jfrog.com/artifactory/)](#artifactoryhttpwwwjfrogcomartifactory)
    - [[nexus_upload](http://www.sonatype.com/nexus/)](#nexus_uploadhttpwwwsonatypecomnexus)
    - [[Appetize.io](https://appetize.io/)](#appetizeiohttpsappetizeio)
    - [[appaloosa](https://www.appaloosa-store.com)](#appaloosahttpswwwappaloosa-storecom)
    - [[Tryouts.io](https://tryouts.io/)](#tryoutsiohttpstryoutsio)
    - [[Installr](https://www.installrapp.com)](#installrhttpswwwinstallrappcom)
  - [Modifying Project](#modifying-project)
    - [[increment_build_number](https://developer.apple.com/library/ios/qa/qa1827/_index.html)](#increment_build_numberhttpsdeveloperapplecomlibraryiosqaqa1827_indexhtml)
    - [[increment_version_number](https://developer.apple.com/library/ios/qa/qa1827/_index.html)](#increment_version_numberhttpsdeveloperapplecomlibraryiosqaqa1827_indexhtml)
    - [set_build_number_repository](#set_build_number_repository)
    - [update_project_team](#update_project_team)
  - [update_info_plist](#update_info_plist)
  - [update_url_schemes](#update_url_schemes)
    - [update_app_identifier](#update_app_identifier)
  - [Developer Portal](#developer-portal)
    - [[match](https://github.com/fastlane/match)](#matchhttpsgithubcomfastlanematch)
    - [[sigh](https://github.com/KrauseFx/sigh)](#sighhttpsgithubcomkrausefxsigh)
    - [[PEM](https://github.com/KrauseFx/PEM)](#pemhttpsgithubcomkrausefxpem)
    - [[cert](https://github.com/KrauseFx/cert)](#certhttpsgithubcomkrausefxcert)
    - [[produce](https://github.com/KrauseFx/produce)](#producehttpsgithubcomkrausefxproduce)
    - [register_devices](#register_devices)
  - [Using git](#using-git)
    - [changelog_from_git_commits](#changelog_from_git_commits)
  ...
  - [Using mercurial](#using-mercurial)
    - [hg_ensure_clean_status](#hg_ensure_clean_status)
    - [hg_commit_version_bump](#hg_commit_version_bump)
    - [hg_add_tag](#hg_add_tag)
    - [hg_push](#hg_push)
  - [Notifications](#notifications)
    - [[Slack](http://slack.com)](#slackhttpslackcom)
    - [[Mailgun](http://www.mailgun.com)](#mailgunhttpwwwmailguncom)
    - [[HipChat](http://www.hipchat.com/)](#hipchathttpwwwhipchatcom)
    - [[Typetalk](https://typetalk.in/)](#typetalkhttpstypetalkin)
    - [[ChatWork](http://www.chatwork.com/)](#chatworkhttpwwwchatworkcom)
    - [Notification](#notification)
    - [[Testmunk](http://testmunk.com)](#testmunkhttptestmunkcom)
    - [[Podio](http://podio.com)](#podiohttppodiocom)
  - [Other](#other)
  ...
  - [Misc](#misc)
    - [appledoc](#appledoc)
    - [download](#download)
    - [version_get_podspec](#version_get_podspec)
    - [version_bump_podspec](#version_bump_podspec)
    - [get_info_plist_value](#get_info_plist_value)
    - [set_info_plist_value](#set_info_plist_value)
    - [say](#say)
    - [clipboard](#clipboard)
    - [is_ci?](#is_ci)
    - [verify_pod_keys](#verify_pod_keys)
    - [read_podspec](#read_podspec)
    - [pod_push](#pod_push)
    - [clean_cocoapods_cache](#clean_cocoapods_cache)
    - [prompt](#prompt)
    - [backup_file](#backup_file)
    - [restore_file](#restore_file)
    - [backup_xcarchive](#backup_xcarchive)
    - [debug](#debug)
    - [dotgpg_environment](#dotgpg_environment)

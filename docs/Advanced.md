...
```ruby
lane_context[SharedValues::LANE_NAME]                 # The name of the current lane
...
To get information about the available environment variables, run `fastlane action [action_name]`.

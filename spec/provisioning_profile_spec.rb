...
describe Spaceship::ProvisioningProfile do
  ...
  describe '#create!' do
    ...
    it 'creates a new appstore provisioning profile' do
      expect(client).to receive(:create_provisioning_profile!).with('Delete Me', 'store', '2UMR2S6PAA', ["XC5PH8DAAA"], ["AAAAAAAAAA", "BBBBBBBBBB", "CCCCCCCCCC", "DDDDDDDDDD"]).and_return({})
  ...
  describe "#repair" do
    ...
    it "repairs an existing profile" do

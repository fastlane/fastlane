describe Fastlane do
  describe Fastlane::FastFile do
    describe "get_github_release" do
      before do
        stub_request(:get, "https://api.github.com/repos/KrauseFx/fastlane/releases").
           with(:headers => {'Host'=>'api.github.com:443', 'User-Agent'=>'excon/0.45.3'}).
      ...
      it "correctly fetches all the data from GitHub" do
        result = Fastlane::FastFile.new.parse("lane :test do
          get_github_release(url: 'KrauseFx/fastlane', version: '1.8.0')
      ...
      it "returns nil if release can't be found" do
        result = Fastlane::FastFile.new.parse("lane :test do
          get_github_release(url: 'KrauseFx/fastlane', version: 'notExistent')
        end").runner.execute(:test)

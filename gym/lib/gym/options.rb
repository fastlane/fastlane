    ...
    def self.plain_options
      [
        ...
        FastlaneCore::ConfigItem.new(key: :silent,
                                     short_option: "-a",
                                     env_name: "GYM_SILENT",
                                     description: "Hide all information that's not necessary while building. Takes precedence over `suppress_xcode_output` and `enabled_xcode_output`",
                                     default_value: false,
                                     is_string: false),
        ...
        FastlaneCore::ConfigItem.new(key: :enabled_xcode_output,
                                     env_name: "GYM_ENABLED_XCODE_OUTPUT",
                                     type: Array,

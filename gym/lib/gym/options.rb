    ...
    def self.plain_options
      [
        ...
        FastlaneCore::ConfigItem.new(key: :codesigning_identity,
                                     ...
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :installer_codesigning_identity,
                                     env_name: "GYM_INSTALLER_CODE_SIGNING_IDENTITY",
                                     description: "The name of the code signing identity for Mac Installer to use. It has to match the name exactly. e.g. '3rd Party Mac Developer Installer: SunApps GmbH'",
                                     optional: true),

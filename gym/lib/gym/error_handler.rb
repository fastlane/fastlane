    ...
    class << self
      ...
      def handle_build_error(output)
        ...
        when /Your build settings specify a provisioning profile with the UUID/
          ...
          print("You can use sigh (https://docs.fastlane.tools/generated/actions/sigh/) to download and install the provisioning profile")
      ...
      def handle_package_error(output)
        ...
        when /requires a provisioning profile/
          ...
          print("Check out the docs on how to fix this: https://docs.fastlane.tools/generated/actions/gym/#export-options")

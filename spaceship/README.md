...
Since your CI system probably doesn't allow you to input values (like the verification code), you can use `fastlane spaceship spaceauth`:

```sh
fastlane spaceship spaceauth -u apple@krausefx.com
```

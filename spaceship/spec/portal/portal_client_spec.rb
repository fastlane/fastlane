...
describe Spaceship::Client do
  ...
  let(:app) { Spaceship::Portal::App.new({ "appIdId" => "ABCD1234", "name" => "Production App", "identifier" => "web.com.fastlane.example", "prefix" => "XXXXXXXXXX", "type" => "explicit", "isWildCard" => false }) }
  describe '#login' do

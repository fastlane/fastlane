...
def du_uploadimage_correct_screenshot
  mock_jpg = double
  allow(mock_jpg).to receive(:file_name).and_return(
             'ftl_FAKEMD5_screenshot1024.jpg'
           )
...
def du_uploadtrailer_preview_correct_jpg
  mock_jpg = double
  allow(mock_jpg).to receive(:file_name).and_return(
             'ftl_FAKEMD5_trailer-en-US_preview.jpg'
           )
...
def du_upload_invalid_geojson
  Spaceship::UploadFile.from_path(
    du_fixture_file_path('upload_invalid.GeoJSON')
  )
end
...
def du_upload_large_image_success
  stub_request(:post, 'https://du-itc.itunes.apple.com/upload/image').with(
    body: 'binary image...',
    headers: {
      ...
      'Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Apple-Jingle-Correlation-Key' =>
        'iOS App:AdamId=898536088:Version=0.9.13',
      'X-Apple-Upload-Appleid' => '898536088',
      'X-Apple-Upload-Contentproviderid' => '1234567',
      'X-Apple-Upload-Itctoken' => 'sso token for image',
      'X-Apple-Upload-Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Apple-Upload-Validation-Rulesets' => 'MZPFT.LargeApplicationIcon',
      'X-Original-Filename' => 'ftl_FAKEMD5_icon1024.jpg'
    }
  )
    .to_return(
    status: 201,
    body: du_read_fixture_file('upload_image_success.json'),
...
def du_upload_watch_image_failure
  stub_request(:post, 'https://du-itc.itunes.apple.com/upload/image').with(
    ...
    headers: {
      ...
      'X-Apple-Upload-Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Apple-Upload-Validation-Rulesets' => 'MZPFT.GizmoAppIcon',
      'X-Original-Filename' => 'ftl_FAKEMD5_icon1024.jpg'
    }
  )
    .to_return(
    status: 400,
    body: du_read_fixture_file('upload_image_failed.json'),
    headers: { 'Content-Type' => 'application/json' }
  )
end

def du_upload_geojson_success
  stub_request(:post, 'https://du-itc.itunes.apple.com/upload/geo-json').with(
    body: du_upload_valid_geojson.bytes,
    headers: {
      'Accept' => 'application/json, text/plain, */*',
      'Accept-Encoding' => 'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
      'Connection' => 'keep-alive',
      'Content-Length' => du_upload_valid_geojson.file_size,
      ...
      'X-Apple-Upload-Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Original-Filename' => 'ftl_FAKEMD5_upload_valid.geojson'
    }
  )
    .to_return(
    status: 201,
    body: du_read_upload_geojson_response_success,
    headers: { 'Content-Type' => 'application/json' }
  )
end
...
def du_upload_geojson_failure
  stub_request(:post, 'https://du-itc.itunes.apple.com/upload/geo-json').with(
    body: du_upload_invalid_geojson.bytes,
    headers: {
      'Accept' => 'application/json, text/plain, */*',
      'Accept-Encoding' => 'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
      'Connection' => 'keep-alive',
      'Content-Length' => du_upload_invalid_geojson.file_size,
      'Content-Type' => 'application/json',
      'Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Apple-Jingle-Correlation-Key' =>
      ...
      'X-Apple-Upload-Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Original-Filename' => 'ftl_FAKEMD5_upload_invalid.GeoJSON'
    }
  )
    .to_return(
    status: 400,
    body: du_read_upload_geojson_response_failed,
    headers: { 'Content-Type' => 'application/json' }
  )
end
...
def du_upload_screenshot_success
  stub_request(:post, 'https://du-itc.itunes.apple.com/upload/image').with(
    ...
    headers: {
      ...
      'X-Apple-Upload-Appleid' => '898536088',
      'X-Apple-Upload-Contentproviderid' => '1234567',
      'X-Apple-Upload-Itctoken' => 'the_sso_token_for_image',
      'X-Apple-Upload-Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Apple-Upload-Validation-Rulesets' => 'MZPFT.SortedN41ScreenShot',
      'X-Original-Filename' => 'ftl_FAKEMD5_screenshot1024.jpg'
    }
  )
    .to_return(
    status: 201,
    body: du_read_upload_screenshot_response_success,
    headers: { 'Content-Type' => 'application/json' }
  )
  ...
  stub_request(:post, 'https://du-itc.itunes.apple.com/upload/image').with(
    ...
    headers: {
      ...
      'Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'User-Agent' => "Spaceship #{Fastlane::VERSION}",
      'X-Apple-Jingle-Correlation-Key' =>
        'iOS App:AdamId=898536088:Version=0.9.13',
      'X-Apple-Upload-Appleid' => '898536088',
      'X-Apple-Upload-Contentproviderid' => '1234567',
      ...
      'X-Apple-Upload-Referrer' =>
        'https://appstoreconnect.apple.com/WebObjects/iTunesConnect.woa/ra/ng/app/898536088',
      'X-Apple-Upload-Validation-Rulesets' => 'MZPFT.SortedScreenShot',
      'X-Original-Filename' => 'ftl_FAKEMD5_screenshot1024.jpg'
    }
  )
    .to_return(
  ...
  stub_request(:post, 'https://du-itc.itunes.apple.com/upload/image').with(
    ...
    headers: {
      ...
      'X-Apple-Upload-Validation-Rulesets' =>
        'MZPFT.SortedN41MessagesScreenShot',
      'X-Original-Filename' => 'ftl_FAKEMD5_screenshot1024.jpg'
    }
  )
    .to_return(

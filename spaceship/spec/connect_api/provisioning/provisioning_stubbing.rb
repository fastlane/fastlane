    ...
    class << self
      ...
      def stub_patch_bundle_id_capability
        ...
        stub_request(:patch, "https://developer.apple.com/services-account/v1/bundleIds/ABCD1234").
          with(body: { "data" => { "type" => "bundleIds", "id" => "ABCD1234", "attributes" => { "identifier" => "com.fastlane.spaceship", "permissions" => { "edit" => true, "delete" => false }, "seedId" => "XXXXXXXXXX", "name" => "Production App", "wildcard" => false, "teamId" => "XXXXXXXXXX" },

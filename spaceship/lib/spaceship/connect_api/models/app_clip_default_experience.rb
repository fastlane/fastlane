...
module Spaceship
  class ConnectAPI
    class AppClipDefaultExperience
      ...
      def self.create(client: nil, app_clip_id:, app_store_version_id:, attributes:)
        client ||= Spaceship::ConnectAPI
        client.post_app_clip_default_experience(app_clip_id: app_clip.id, app_store_version_id: version.id, attributes: { action: action })
      end

  ...
  class TunesClient < Spaceship::Client
    ...
    def select_team
      ...
      if t_name.length > 0 && t_id.length.zero? # we prefer IDs over names, they are unique
        puts "Looking for iTunes Connect Team with name #{t_name}" if FastlaneCore::Globals.verbose?
      ...
      if t_id.length > 0
        puts "Looking for iTunes Connect Team with ID #{t_id}" if FastlaneCore::Globals.verbose?

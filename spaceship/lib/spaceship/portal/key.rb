...
module Spaceship
  module Portal
    class Key < PortalBase
      ...
      APPLE_ID_AUTH_KEY = 'APPLE_ID_AUTH_KEY_CONFIGURATION'
      ...
      # @param app_id [String] use the id of the primary app identifier to make Sign In with Apple auth key
      def self.create(name: nil, apns: nil, device_check: nil, music_id: nil, app_id: nil)
        service_config = {}
        ...
        service_config[APPLE_ID_AUTH_KEY] = [app_id] if app_id
      ...
      def has_apple_id_auth_key?
        has_service?(APPLE_ID_AUTH_KEY)
      end

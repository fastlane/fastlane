...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'credentials_manager', '>= 0.8.3', '< 1.0.0' # Password Manager
  spec.add_dependency 'spaceship', '>= 0.11.2', '< 1.0.0' # communication layer with Apple's web services

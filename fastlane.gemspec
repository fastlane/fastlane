...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'cupertino', '~> 1.3' # for registering iOS devices with the Apple Developer Center
  spec.add_dependency 'fastlane_core', '>= 0.3.4' # all shared code and dependencies

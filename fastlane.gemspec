...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'credentials_manager', '>= 0.8.4', '< 1.0.0' # Password Manager
  spec.add_dependency 'spaceship', '>= 0.11.5', '< 1.0.0' # communication layer with Apple's web services

  # All the fastlane tools
  spec.add_dependency 'deliver', '>= 1.2.0', '< 2.0.0'
  ...
  spec.add_dependency 'gym', '>= 0.8.4', '< 1.0.0'

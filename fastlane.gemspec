...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'fastlane_core', '>= 0.25.2', '< 1.0.0' # all shared code and dependencies
  spec.add_dependency 'credentials_manager', '>= 0.9.1', '< 1.0.0' # Password Manager
  spec.add_dependency 'spaceship', '>= 0.12.2', '< 1.0.0' # communication layer with Apple's web services

  # All the fastlane tools
  spec.add_dependency 'deliver', '>= 1.3.3', '< 2.0.0'
  spec.add_dependency 'snapshot', '>= 0.10.2', '< 1.0.0'
  ...
  spec.add_dependency 'supply', '>= 0.1.0', '< 1.0.0'
  spec.add_dependency 'scan', '>= 0.1.0', '< 1.0.0'

...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'fastlane_core', '>= 0.18.1', '< 1.0.0' # all shared code and dependencies
  spec.add_dependency 'credentials_manager', '>= 0.8.2', '< 1.0.0' # Password Manager
  spec.add_dependency 'spaceship', '>= 0.10.1', '< 1.0.0' # communication layer with Apple's web services

  # All the fastlane tools
  spec.add_dependency 'deliver', '>= 1.0.0', '< 2.0.0'
  spec.add_dependency 'snapshot', '>= 0.10.0', '< 1.0.0'
  ...
  spec.add_dependency 'gym', '>= 0.8.3', '< 1.0.0'
  spec.add_dependency 'pilot', '>= 0.2.1', '< 1.0.0'

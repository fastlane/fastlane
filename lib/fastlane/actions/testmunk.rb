        ...
        [
          FastlaneCore::ConfigItem.new(key: :ipa,
                                       ...
                                       verify_block: proc do |value|
                                         fail "Please pass to existing ipa" unless File.exist? value
                                       end),
          FastlaneCore::ConfigItem.new(key: :email,
                                       env_name: "TESTMUNK_EMAIL",
                                       description: "Your email address",
                                       verify_block: proc do |value|
                                         fail "Please pass your Testmunk email address using `ENV['TESTMUNK_EMAIL'] = 'value'`" unless value
                                       end),
          FastlaneCore::ConfigItem.new(key: :api,
                                       env_name: "TESTMUNK_API",
                                       description: "Testmunk API Key",
                                       verify_block: proc do |value|
                                         fail "Please pass your Testmunk API Key using `ENV['TESTMUNK_API'] = 'value'`" unless value
                                       end),
          FastlaneCore::ConfigItem.new(key: :app,
                                       env_name: "TESTMUNK_APP",
                                       description: "Testmunk App Name",
                                       verify_block: proc do |value|
                                         fail "Please pass your Testmunk app name using `ENV['TESTMUNK_APP'] = 'value'`" unless value
                                       end)
        ]
      end

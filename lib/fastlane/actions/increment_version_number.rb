      ...
      def self.run(params)
        ...
        if params[:version_number]
          ...
          if Helper.test?
            ...
            fail "Your current version (#{current_version}) does not respect the format A.B.C" unless current_version.match(/\d.\d.\d/)
        ...
        [
          FastlaneCore::ConfigItem.new(key: :bump_type,
                                       ...
                                       verify_block: proc do |value|
                                         fail "Available values are 'patch', 'minor' and 'major'" unless %w(patch minor major).include? value
                                       end),

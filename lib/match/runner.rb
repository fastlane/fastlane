module Match
  class Runner
    ...
    def run(params)
      ...
      unless spaceship.certificate_exists?(cert_id)
        UI.error("Certificate '#{cert_id}' (stored in your git repo) is not available on the Developer Portal")
      ...
      unless spaceship.profile_exists?(uuid)

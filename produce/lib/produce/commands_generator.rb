  ...
  class CommandsGenerator
    ...
    def run
      ...
      command :enable_services do |c|
        ...
        c.option('--increased-memory-limit', 'Enable Increased Memory Limit')
        c.option('--increased-memory-limit-debugging', 'Enable Increased Debugging Memory Limit')
      ...
      command :disable_services do |c|
        ...
        c.option('--increased-memory-limit', 'Disable Increased Memory Limit')
        c.option('--increased-memory-limit-debugging', 'Disable Increased Debugging Memory Limit')

  ...
  class CommandsGenerator
    ...
    def run
      ...
      command :create do |c|
        ...
        c.description =
          'Creates a new app on App Store Connect and the Apple Developer Portal'
      ...
      command :enable_services do |c|
        c.syntax =
          'fastlane produce enable_services -a APP_IDENTIFIER SERVICE1, SERVICE2, ...'
        c.description =
          'Enable specific Application Services for a specific app on the Apple Developer Portal'
        c.example(
          'Enable HealthKit, HomeKit and Passbook',
          'fastlane produce enable_services -a com.example.app --healthkit --homekit --passbook'
        )
        ...
        c.option(
          ...
          String,
          'Enable Data Protection, suitable values are "complete", "unlessopen" and "untilfirstauth"'
        )
        ...
        c.option(
          '--icloud STRING',
          String,
          'Enable iCloud, suitable values are "legacy" and "cloudkit"'
        )
        ...
        c.option(
          '--push-notification',
          'Enable Push notification (only enables the service, does not configure certificates)'
        )
        ...
        c.action do |args, options|
          ...
          allowed_keys =
            Produce::Options.available_options.collect(&:key)
          Produce.config =
            FastlaneCore::Configuration.create(
              Produce::Options.available_options,
              options.__hash__.select do |key, value|
      ...
      command :disable_services do |c|
        c.syntax =
          'fastlane produce disable_services -a APP_IDENTIFIER SERVICE1, SERVICE2, ...'
        c.description =
          'Disable specific Application Services for a specific app on the Apple Developer Portal'
        c.example(
          'Disable HealthKit',
          'fastlane produce disable_services -a com.example.app --healthkit'
        )
      ...
      command :group do |c|
        ...
        c.example(
          'Create group',
          'fastlane produce group -g group.example.app -n "Example App Group"'
        )
        ...
        c.option(
          ...
          '--group_name STRING',
          String,
          'Name for the group that is created (PRODUCE_GROUP_NAME)'
        )
        c.option(
          '-g',
          '--group_identifier STRING',
          String,
          'Group identifier for the group (PRODUCE_GROUP_IDENTIFIER)'
        )
      ...
      command :associate_group do |c|
        c.syntax =
          'fastlane produce associate_group -a APP_IDENTIFIER GROUP_IDENTIFIER1, GROUP_IDENTIFIER2, ...'
        c.description =
          'Associate with a group, which is created if needed or simply located otherwise'
        c.example(
          'Associate with group',
          'fastlane produce associate-group -a com.example.app group.example.com'
        )
      ...
      command :cloud_container do |c|
        ...
        c.option(
          ...
          String,
          'Name for the iCloud Container that is created (PRODUCE_CLOUD_CONTAINER_NAME)'
        )
        c.option(
          '-g',
          '--container_identifier STRING',
          String,
          'Identifier for the iCloud Container (PRODUCE_CLOUD_CONTAINER_IDENTIFIER'
        )
      ...
      command :associate_cloud_container do |c|
        c.syntax =
          'fastlane produce associate_cloud_container -a APP_IDENTIFIER CONTAINER_IDENTIFIER1, CONTAINER_IDENTIFIER2, ...'
        c.description =
          'Associate with a iCloud Container, which is created if needed or simply located otherwise'
        c.example(
          'Associate with iCloud Container',
          'fastlane produce associate_cloud_container -a com.example.app iCloud.com.example.com'
        )
      ...
      command :merchant do |c|
        ...
        c.option(
          ...
          String,
          'Name for the merchant that is created (PRODUCE_MERCHANT_NAME)'
        )
        c.option(
          '-o',
          '--merchant_identifier STRING',
          String,
          'Merchant identifier for the merchant (PRODUCE_MERCHANT_IDENTIFIER)'
        )
        ...
        c.action do |args, options|
          extra_options = [
            FastlaneCore::ConfigItem.new(key: :merchant_name, optional: true),
      ...
      command :associate_merchant do |c|
        c.syntax =
          'fastlane produce associate_merchant -a APP_IDENTIFIER MERCHANT_IDENTIFIER1, MERCHANT_IDENTIFIER2, ...'
        c.description =
          'Associate with a merchant for use with Apple Pay. Apple Pay will be enabled for this app.'
        c.example(
          'Associate with merchant',
          'fastlane produce associate_merchant -a com.example.app merchant.com.example.production'
        )

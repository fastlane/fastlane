...
module Produce
  class DeveloperCenter
    ...
    def run
      login
      create_new_app
      # Connect API create already enables capabilities via enable_inline_services.
      # The Portal path still needs this for capabilities Apple only exposes on Connect API.
      enable_connect_api_services unless using_connect_api?
    end

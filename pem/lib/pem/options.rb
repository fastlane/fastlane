    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(
          ...
          is_string: false,
          conflicting_options: %i[development],
          default_value: false
        ),
        FastlaneCore::ConfigItem.new(
          key: :generate_p12,
        ...
        FastlaneCore::ConfigItem.new(
          ...
          verify_block:
            proc do |value|
              unless value.kind_of?(Integer) && value > 0
                UI.user_error!(
                  'Value of active_days_limit must be a positive integer or left blank'
                )
              end
            end
        ),

...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "fastlane_core", ">= 0.56.0", "< 1.0.0" # all shared code and dependencies
  spec.add_dependency "spaceship", ">= 0.37.0", "< 1.0.0" # Communicating with the Apple Dev Portal

def stub_spaceship
  ...
  allow(Spaceship.certificate.production_push).to receive(:create!).with(csr: csr, bundle_id: "com.krausefx.app").and_return(cert)
  allow(Spaceship.certificate.development_push).to receive(:create!).with(csr: csr, bundle_id: "com.krausefx.app.development").and_return(cert)
  allow(Spaceship.certificate.voip_push).to receive(:create!).with(csr: csr, bundle_id: "com.krausefx.app.voip").and_return(cert)

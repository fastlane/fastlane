...
describe Frameit::Device do
  ...
  describe "#detect_device" do
    ...
    describe "valid iOS screen sizes" do
      ...
      it "should detect iPhone XS in portrait and landscape based on priority" do
        expect_screen_size_from_file("screenshot-Portrait{1125x2436}.jpg", Platform::IOS).to eq(Devices::IPHONE_XS)
        expect_screen_size_from_file("screenshot-Landscape{2436x1125}.jpg", Platform::IOS).to eq(Devices::IPHONE_XS)
      end

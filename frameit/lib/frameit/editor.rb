...
module Frameit
  ...
  class Editor # rubocop:disable Metrics/ClassLength
    ...
    def put_title_into_background(background, stack_title)
      ...
      ratio_vertical = title.height.to_f / (effective_text_height || actual_font_size) # The fraction of the actual height of the images compared to the available space

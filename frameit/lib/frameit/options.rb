    ...
    def self.available_options
      @options ||= begin
        color_options = [
          ...
          { key: :blue, env_name: "FRAMEIT_BLUE_FRAME", description: "Use blue device frames" },
          { key: :red, env_name: "FRAMEIT_RED_FRAME", description: "Use red device frames" }
        ]

        options = color_options.map do |option|

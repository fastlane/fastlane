...
describe Deliver::AppScreenshot do
  ...
  describe "#initialize" do
    ...
    context "when filename contains 'iPad Pro (3rd generation)'" do
      it "returns iPad Pro(12.9-inch) 3rd generation" do
        ...
        expect(screenshot.screen_size).to eq(Deliver::AppScreenshot::ScreenSize::IOS_IPAD_PRO_13)
      end
    end

    context "when filename contains 'iPad Pro (4th generation)'" do
      it "returns iPad Pro(12.9-inch) 4th generation" do
    ...
    context "when filename contains 'iPad Pro (5th generation)'" do
      it "returns iPad Pro(12.9-inch) 5th generation" do
    ...
    context "when filename contains 'iPad Pro (M4)'" do
      it "returns iPad Pro(12.9-inch) M4 generation" do
        screenshot = Deliver::AppScreenshot.new("path/to/screenshot/Screen-Name-iPad Pro (13-inch) (M4){2732x2048}.png", "de-DE")
        expect(screenshot.screen_size).to eq(Deliver::AppScreenshot::ScreenSize::IOS_IPAD_PRO_13)
      end
    end
  ...
  describe "#calculate_screen_size" do
    ...
    describe "valid screen sizes" do
      it "should calculate all 6.9 inch iPhone resolutions" do
        expect_screen_size_from_file("iPhone14ProMax-Portrait{1320x2868}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69)
        expect_screen_size_from_file("iPhone14ProMax-Landscape{2868x1320}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69)
        expect_screen_size_from_file("iPhone14ProMax-Portrait{1290x2796}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69)
        expect_screen_size_from_file("iPhone14ProMax-Landscape{2796x1290}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69)
      end
      ...
      it "should calculate all 6.3 inch iPhone resolutions" do
      ...
      it "should calculate all 6.1 inch iPhone resolutions" do
        expect_screen_size_from_file("iPhone14Pro-Portrait{1170x2532}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61)
        expect_screen_size_from_file("iPhone14Pro-Landscape{2532x1170}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61)
        expect_screen_size_from_file("iPhone14Pro-Portrait{1125x2436}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61)
        expect_screen_size_from_file("iPhone14Pro-Landscape{2436x1125}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61)
        expect_screen_size_from_file("iPhone14Pro-Portrait{1080x2340}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61)
        expect_screen_size_from_file("iPhone14Pro-Landscape{2340x1080}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61)
      end
    ...
    describe "valid iMessage app screen sizes" do
      it "should calculate all 6.9 inch iPhone resolutions" do
        expect_screen_size_from_file("iMessage/en-GB/iPhone14ProMax-Portrait{1320x2868}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14ProMax-Landscape{2868x1320}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14ProMax-Portrait{1290x2796}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14ProMax-Landscape{2796x1290}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_69_MESSAGES)
      end
      ...
      it "should calculate all 6.1 inch iPhone resolutions" do
        expect_screen_size_from_file("iMessage/en-GB/iPhone14Pro-Portrait{1170x2532}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14Pro-Landscape{2532x1170}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14Pro-Portrait{1125x2436}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14Pro-Landscape{2436x1125}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14Pro-Portrait{1080x2340}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61_MESSAGES)
        expect_screen_size_from_file("iMessage/en-GB/iPhone14Pro-Landscape{2340x1080}.jpg").to eq(Deliver::AppScreenshot::ScreenSize::IOS_61_MESSAGES)
      end
  ...
  describe "#device_type" do
    ...
    it "should return iphone69 for 6.9 inch displays" do
      expect(app_screenshot_with(Deliver::AppScreenshot::ScreenSize::IOS_69).device_type).to eq("APP_IPHONE_69")
      expect(app_screenshot_with(Deliver::AppScreenshot::ScreenSize::IOS_69_MESSAGES).device_type).to eq("IMESSAGE_APP_IPHONE_69")
    end

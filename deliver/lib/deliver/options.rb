    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :screenshots_path,
                                     ...
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :skip_downloaded,
                                     description: "Don't download screenshots that are already present locally, based on file presence",
                                     is_string: false,
                                     default_value: false),
        ...
        FastlaneCore::ConfigItem.new(key: :skip_screenshots,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :skip_uploaded_screenshots,
                                     description: "Don't upload screenshots for language variants whose screenshots have already been uploaded",
                                     is_string: false,
                                     default_value: false),

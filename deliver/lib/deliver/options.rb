    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :submit_for_review,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :reject_if_waiting_for_review,
                                     env_name: "DELIVER_REJECT_IF_WAITING_FOR_REVIEW",
                                     description: "Rejects the previously submitted build if the status is \"Waiting for review\"",
                                     is_string: false,
                                     default_value: false),

    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :precheck_include_in_app_purchases,
                                     ...
                                     optional: true,
                                     default_value: true),
        FastlaneCore::ConfigItem.new(key: :precheck_skip_unreachable_urls,
                                     env_name: "PRECHECK_SKIP_UNREACHABLE_URLS",
                                     description: "Skip precheck's unreachable URL check on app metadata",
                                     type: Boolean,
                                     optional: true,
                                     default_value: false),

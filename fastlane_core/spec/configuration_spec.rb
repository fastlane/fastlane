  ...
  describe FastlaneCore::Configuration do
    ...
    description: "Set the profile name."
      ...
      describe "auto_convert_value" do
        ...
        it "auto converts Array in String to actual Array" do
        ...
        it "auto converts list of quoted Strings to actual Array" do
          config_item = FastlaneCore::ConfigItem.new(key: :app_identifier,
                                       short_option: "-a",
                                       env_name: "MATCH_APP_IDENTIFIER",
                                       description: "The bundle identifier(s) of your app (comma-separated)",
        ...
        it "auto converts list of quoted single String to actual Array" do
          config_item = FastlaneCore::ConfigItem.new(key: :app_identifier,
                                       short_option: "-a",
                                       env_name: "MATCH_APP_IDENTIFIER",
                                       description: "The bundle identifier(s) of your app (comma-separated)",
        ...
        it "auto converts list of single String to actual Array" do
          config_item = FastlaneCore::ConfigItem.new(key: :app_identifier,
                                       short_option: "-a",
                                       env_name: "MATCH_APP_IDENTIFIER",
                                       description: "The bundle identifier(s) of your app (comma-separated)",
        ...
        it "doesn't do anything for auto conversion of an Array of Strings" do
          config_item = FastlaneCore::ConfigItem.new(key: :app_identifier,
                                       short_option: "-a",
                                       env_name: "MATCH_APP_IDENTIFIER",
                                       description: "The bundle identifier(s) of your app (comma-separated)",

...
module FastlaneCore
  ...
  class ActionCompletionContext
    ...
    def initialize(
      p_hash: nil, action_name: nil, status: nil, fastlane_client_language: nil
    )
      @p_hash = p_hash
    ...
    def self.context_for_action_name(
      action_name, fastlane_client_language: :ruby, args: nil, status: nil
    )

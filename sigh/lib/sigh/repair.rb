...
module Sigh
  class Repair
    def repair_all
      ...
      broken_profiles =
        Spaceship.provisioning_profile.all.find_all do |profile|
      ...
      UI.success(
        "Going to repair #{broken_profiles.count} provisioning profiles"
      )
      ...
      UI.success(
        "Successfully repaired #{broken_profiles.count} provisioning profiles"
      )
    end
  end
end

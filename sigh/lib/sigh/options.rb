    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :skip_certificate_verification,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :skip_profile_creation,
                                     env_name: "SIGH_SKIP_PROFILE_CREATION",
                                     description: "Skips the creation of profiles if no profiles can be found on the Apple Developer Portal",
                                     is_string: false,
                                     default_value: false),

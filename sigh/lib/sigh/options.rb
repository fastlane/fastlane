    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :cert_serial_number,
                                    ...
                                    description: "The Serial Number of the code signing certificate to use (e.g. 06:9f:ba:78:51:58:dc:46:d9:a6:60:3e:af:5a:13:16). Takes precedence over cert_id. Intended to be used when cert_id data is not present or lost. Example: manually created certificates dont contain any cert_id data (in contrast to API created ones).",
                                    optional: true),
